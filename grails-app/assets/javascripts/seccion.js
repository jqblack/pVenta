$(document).ready(function(){
    ...
    init_tabla_secciones()

    function init_tabla_secciones() {
        $.ajax({
            url: window.location + '/get_secciones',
            type: 'POST',
            dataType: 'JSON',
            success: function(response) {
                ...
                {
                    config_tabla_secciones(response.secciones)
                }
                else{
    ...
    function config_tabla_secciones(data)
    {
    ...
    $('#secciones_lista').on('rowclick', function (event){

        $('#id').val($('#secciones_lista').jqxGrid('getrowdata', event.args.rowindex).id);
        $('#descripcion').val($('#secciones_lista').jqxGrid('getrowdata', event.args.rowindex).fDescripcion);
