...
<div class="row">
    <div class="col-6">
        <div class="card">
            <div class="card-header"><b>Cuentas por cobrar</b>
            </div>
                            ...
                            <div class="card-body">
                                <div class="form-group col-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control " id="nombre" name="nombre" type="text" placeholder="Nombre"  onkeyup="press_enter(event)">
                ...
                <div class="row">
                    <div class="col-12 mb-2">
                        <div class="btn-group pull-right" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-primary" id="btn-toolbar-abonar"><i class="icons font-2xl d-block mt-2 fa fa-dollar"></i> Pago de Factura</button>
                            <button type="button" class="btn btn-primary" id="btn-toolbar-saldar"><i class="icons font-2xl d-block mt-2 fa fa-dollar"></i>Saldar de cuentas</button>
                    ...
                    <div class="col-12 col-md-12">
                        <form id="frmAbono">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control font-weight-bold text-right total-input"
                                       placeholder="0.00" name="abono-pago" id="abono-pago" oninput="validar_numero(event,this.id)">
                            </div>
                        </form>
                    </div>
                </div>
...
<asset:javascript src="cuenta_por_cobrar.js"/>
