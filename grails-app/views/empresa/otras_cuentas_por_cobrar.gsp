...
<div class="row">
    <div class="col-6">
        <div class="card">
            <div class="card-header"><b>Otras cuentas por cobrar</b>
            </div>
                ...
                <div class="row">
                    <div class="col-12 mb-2">
                        <div class="btn-group pull-right" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-primary" id="btn-toolbar-generar-cuenta"><i class="icons font-2xl d-block mt-2 fa fa-dollar"></i> Generar Cuenta</button>
...
<div class="modal fade" id="abono-cuenta-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-12 col-md-12">
                        <form id="frmAbono">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control font-weight-bold text-right total-input" placeholder="0.00" name="abono-pago" id="abono-pago">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" id="btn-abono-pagar">Guardar</button>
            </div>
        </div>
        <!-- /.modal-content-->
    </div>
...
<asset:javascript src="otras_cuentas_por_cobrar.js"/>
