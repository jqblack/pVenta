...
public class WebServices {
    ...
    public static String url_rnc;//"http://199.217.112.100:8080/abacus/appws/";
    ...
    public boolean verificarRespuesta(String json) throws IOException {
        ...
        if (r.equals("-1")) {
            ...
            JOptionPane.showMessageDialog(null, "Existe una session abierta de este usuario", "Informacion", JOptionPane.ERROR_MESSAGE);
            paso = false;
        } else if (r.equals("-4")) {
            JOptionPane.showMessageDialog(null, "La Sessión a caducado, haga click en salir del sistema e inicie de nuevo.", "Informacion", JOptionPane.ERROR_MESSAGE);
            paso = false;
    ...
    public String valida_rnc(String rnc) throws IOException {

//        String uri = "http://jqmicrosistemas.com/rnc/run.php?rnc="+rnc;
        String uri = url_rnc+"/rnc/run.php?rnc="+rnc;
        
        System.err.println(uri);
        javax.ws.rs.client.Client client = ClientBuilder.newClient();
        javax.ws.rs.client.WebTarget webTarget = client.target(uri);
        Response response = null;
        try {
