 ...
 * @author Usuario
 */
public class FrmOutActivarCamarero extends javax.swing.JDialog {
    ...
    public FrmOutActivarCamarero(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void llenar_camareros() {
        ...
        try {
            ...
            respuesta = webServices.buscar("\"f_parametro\":\"" + parametro.getText() + "\"", "ws/get_activar_camareros_by_parametros");
            if (!respuesta.equals("")) {
                ...
                for (Map tupla : map1) {
                    ...
                    if (Boolean.valueOf(tupla.get("f_activo").toString())) {
                        button1.setBackground(new Color(0, 153, 0));
                    } else {
                        button1.setBackground(new Color(255, 51, 51));
                    }

                    button1.setFont(new Font("Tahoma", 1, 18));
                    button1.setName(tupla.get("f_idrecord").toString() + ";" + tupla.get("f_activo").toString());
                    ...
                    button1.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            String[] split = button1.getName().split(";");
                            setIdcamarero(split[0]);
                            setNombre_camarero(button1.getText());
                            eventoActivarCamareros(split[1]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmOutActivarCamarero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmOutActivarCamarero().setVisible(true);
            }
        });
    }
    ...
    public void eventoActivarCamareros(String activo) {
        FrmInActivarDesactivarCamarero frm = new FrmInActivarDesactivarCamarero((JFrame) this.getParent(), true, getNombre_camarero(), getIdcamarero(), activo);
        frm.setVisible(true);
        frm.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                ...
                if (frm.getSi_no()) {
                    funciones.mensaje("Actualización realizada con exito", "", JOptionPane.INFORMATION_MESSAGE);
                    buscar.doClick();
