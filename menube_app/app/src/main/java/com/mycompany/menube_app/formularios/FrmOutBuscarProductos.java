 ...
 * @author Usuario
 */
public class FrmOutBuscarProductos extends javax.swing.JDialog {
    ...
    public FrmOutBuscarProductos() {
        initComponents();
    }

    public FrmOutBuscarProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        llenar_tabla();
    }
    ...
    private void initComponents() {
        ...
        tabla_datos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "REFERENCIA", "DESCRIPCION", "EXISTENCIA", "PRECIO"
            }
        ) {
        ...
        tabla_datos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tabla_datosKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(tabla_datos);
        if (tabla_datos.getColumnModel().getColumnCount() > 0) {
            tabla_datos.getColumnModel().getColumn(0).setHeaderValue("id");
            tabla_datos.getColumnModel().getColumn(1).setHeaderValue("REFERENCIA");
            tabla_datos.getColumnModel().getColumn(2).setHeaderValue("DESCRIPCION");
            tabla_datos.getColumnModel().getColumn(3).setHeaderValue("EXISTENCIA");
            tabla_datos.getColumnModel().getColumn(4).setHeaderValue("PRECIO");
        }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtparametro, javax.swing.GroupLayout.PREFERRED_SIZE, 836, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tabla_datosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_datosMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            setIdproducto(tabla_datos.getModel().getValueAt(tabla_datos.getSelectedRow(), 0).toString());
    ...
    private void tabla_datosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_datosKeyPressed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_tabla_datosKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmOutBuscarProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmOutBuscarProductos().setVisible(true);
            }
        });
    }
    ...
    public void llenar_productos() {
        ...
        try {
            ...
            respuesta = webServices.buscar("\"f_parametro\":\"" + txtparametro.getText() + "\"", "ws/get_productos_by_parametro");
            if (!respuesta.equals("")) {
                ...
                for (Map tupla : map1) {
                    ...
                    model.addRow(new Object[]{
                        ...
                        tupla.get("f_referencia"),//referencia del prodcuto
                        tupla.get("f_descripcion"),//descripcion del producto
                        funciones.Round(funciones.parseDouble(tupla.get("f_existencia").toString()), 2),//existencia producto
                        funciones.Round(funciones.parseDouble(tupla.get("f_precio").toString()), 2)//precio producto
                    });
                }
                if (tabla_datos.getRowCount() > 0) {
                    tabla_datos.setRowSelectionInterval(0,0);
                    tabla_datos.requestFocus();
                }
