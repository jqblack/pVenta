...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,93);
if (RapidSub.canDelegate("completejob")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
RemoteObject _job = RemoteObject.declareNull("com.menube.app.httpjob");
...
Debug.ShouldStop(32);
_job.runClassMethod (com.menube.app.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,70);
if (RapidSub.canDelegate("hc_responseerror")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("com.menube.app.httpjob");
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,55);
if (RapidSub.canDelegate("hc_responsesuccess")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("com.menube.app.httpjob");
Debug.locals.put("Response", _response);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,62);
if (RapidSub.canDelegate("response_streamfinish")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,13);
if (RapidSub.canDelegate("service_create")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","49961480",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 22;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(2097152);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","49961481",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
try {
		Debug.PushSubsStack("Service_Destroy (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,36);
if (RapidSub.canDelegate("service_destroy")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
try {
		Debug.PushSubsStack("Service_Start (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,32);
if (RapidSub.canDelegate("service_start")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",9,httputils2service.processBA,httputils2service.mostCurrent,42);
if (RapidSub.canDelegate("submitjob")) { return com.menube.app.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (com.menube.app.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(httputils2service._taskcounter),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 49;BA.debugLine="hc.Execute(job.GetRequest, taskCounter)";
Debug.ShouldStop(65536);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (com.menube.app.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(httputils2service._taskcounter));
 };
