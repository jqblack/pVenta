...
views.get("panelconfiguracion").vw.setHeight((int)((views.get("btnconfiguracion").vw.getHeight())));
...
views.get("panel1").vw.setTop((int)((views.get("label3").vw.getTop() + views.get("label3").vw.getHeight())+(13d / 100 * height)));
...
views.get("lblregistrarme").vw.setTop((int)((views.get("btnlogin").vw.getTop() + views.get("btnlogin").vw.getHeight())));
...
//BA.debugLineNum = 62;BA.debugLine="Label2.Width = 100%x"[frmLogin/General script]
views.get("label2").vw.setWidth((int)((100d / 100 * width)));
//BA.debugLineNum = 63;BA.debugLine="Label2.Left = 0"[frmLogin/General script]
views.get("label2").vw.setLeft((int)(0d));
//BA.debugLineNum = 64;BA.debugLine="Label2.Bottom = 100%y"[frmLogin/General script]
