...
//BA.debugLineNum = 111;BA.debugLine="Panel6.Width = Panel2.Width"[frmRegistroCliente/General script]
views.get("panel6").vw.setWidth((int)((views.get("panel2").vw.getWidth())));
//BA.debugLineNum = 112;BA.debugLine="Panel6.Top = Label6.Bottom"[frmRegistroCliente/General script]
views.get("panel6").vw.setTop((int)((views.get("label6").vw.getTop() + views.get("label6").vw.getHeight())));
//BA.debugLineNum = 113;BA.debugLine="Panel6.Height = Panel2.Height"[frmRegistroCliente/General script]
views.get("panel6").vw.setHeight((int)((views.get("panel2").vw.getHeight())));
//BA.debugLineNum = 115;BA.debugLine="txtContrasenaRegistro.Left = txtNombre.Left"[frmRegistroCliente/General script]
