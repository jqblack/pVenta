...
public class b4i_anotherprogressbar {
    public static RemoteObject myClass;
	public b4i_anotherprogressbar() {
	}
    public static PCBA staticBA = new PCBA(null, b4i_anotherprogressbar.class);
...
public static RemoteObject _busybrush = RemoteObject.declareNull("_bcbrush");
...
public static RemoteObject _miv = RemoteObject.declareNull("B4XViewWrapper");
public static RemoteObject _transparentbrush = RemoteObject.declareNull("_bcbrush");
public static RemoteObject _vertical = RemoteObject.createImmutable(false);
public static RemoteObject _currentvalue = RemoteObject.createImmutable(0.0f);
public static RemoteObject _emptycolor = RemoteObject.createImmutable(0);
public static RemoteObject _emptybrush = RemoteObject.declareNull("_bcbrush");
...
public static RemoteObject _valuechangepersecond = RemoteObject.createImmutable(0.0f);
