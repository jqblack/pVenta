...
public class b4i_anotherprogressbar_subs_0 {


public static RemoteObject  _base_resize(RemoteObject __ref,RemoteObject _width,RemoteObject _height) throws Exception{
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,48);
...
Debug.JustUpdateDeviceLine();
_v.runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, _width)),(Object)(BA.numberCast(float.class, _height)));
 }
}Debug.locals.put("v", _v);
;
 BA.debugLineNum = 52;BA.debugLine="bc.Initialize(mBase.Width / xui.Scale, mBase.Heig";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bc" /*RemoteObject*/ ).runVoidMethod ("_initialize:::",__ref.getField(false, "bi"),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width"),__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Scale")}, "/",0, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Scale")}, "/",0, 0))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_anotherprogressbar.class, "_updategraphics" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,58);
...
public ResumableSub_BusyLoop(b4i_anotherprogressbar parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
RemoteObject _tasks = RemoteObject.declareNull("B4IList");
RemoteObject _delta = RemoteObject.createImmutable(0.0f);
RemoteObject _change = RemoteObject.createImmutable(0.0f);
...
Debug.JustUpdateDeviceLine();
_lasttime = b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now");Debug.locals.put("LastTime", _lasttime);Debug.locals.put("LastTime", _lasttime);
...
Debug.JustUpdateDeviceLine();
_tasks = RemoteObject.createNew ("B4IList");Debug.locals.put("tasks", _tasks);
...
Debug.JustUpdateDeviceLine();
_tasks.runVoidMethod ("Add:",(Object)((__ref.getField(false,"_bc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrect::::",(Object)(__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(false,"_targetrect")),(Object)(__ref.getField(false,"_transparentbrush" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(int.class, 0))))));
...
//if
this.state = 21;
if (RemoteObject.solveBoolean("k",b4i_main.__c.runMethod(true,"Abs:",(Object)(BA.numberCast(double.class, _delta))),BA.numberCast(double.class, 1))) { 
this.state = 12;
}else {
this.state = 14;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
_lasttime = b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now");Debug.locals.put("LastTime", _lasttime);
...
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setBottom:",BA.numberCast(float.class, b4i_main.__c.runMethod(true,"Round:",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentvalue" /*RemoteObject*/ ),RemoteObject.createImmutable(100),__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(true,"_mheight")}, "/*",0, 0)))));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setRight:",BA.numberCast(float.class, b4i_main.__c.runMethod(true,"Round:",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentvalue" /*RemoteObject*/ ),RemoteObject.createImmutable(100),__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(true,"_mwidth")}, "/*",0, 0)))));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
_tasks.runVoidMethod ("Add:",(Object)((__ref.getField(false,"_bc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrectrounded:::::",(Object)(_r),(Object)(__ref.getField(false,"_busybrush" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(true,"_cornerradius" /*RemoteObject*/ ))))));
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("WaitFor::::","bc_bitmapready:", __ref.getField(false, "bi"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "anotherprogressbar", "busyloop"), null);
this.state = 38;
return;
case 38:
//C
this.state = 31;
_bmp = (RemoteObject) result.runMethod(false,"objectAtIndex:", RemoteObject.createImmutable(1));Debug.locals.put("bmp", _bmp);
;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "anotherprogressbar", "busyloop"),BA.numberCast(int.class, 30));
this.state = 39;
return;
case 39:
//C
...
b4i_anotherprogressbar._meventname = RemoteObject.createImmutable("");__ref.setField("_meventname",b4i_anotherprogressbar._meventname);
 //BA.debugLineNum = 6;BA.debugLine="Private mCallBack As Object 'ignore";
b4i_anotherprogressbar._mcallback = RemoteObject.createNew ("NSObject");__ref.setField("_mcallback",b4i_anotherprogressbar._mcallback);
 //BA.debugLineNum = 7;BA.debugLine="Public mBase As B4XView 'ignore";
b4i_anotherprogressbar._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_anotherprogressbar._mbase);
 //BA.debugLineNum = 8;BA.debugLine="Private xui As XUI 'ignore";
b4i_anotherprogressbar._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_anotherprogressbar._xui);
 //BA.debugLineNum = 9;BA.debugLine="Private BusyBrush As BCBrush";
b4i_anotherprogressbar._busybrush = RemoteObject.createNew ("_bcbrush");__ref.setField("_busybrush",b4i_anotherprogressbar._busybrush);
 //BA.debugLineNum = 10;BA.debugLine="Private BackgroundColor As Int";
b4i_anotherprogressbar._backgroundcolor = RemoteObject.createImmutable(0);__ref.setField("_backgroundcolor",b4i_anotherprogressbar._backgroundcolor);
 //BA.debugLineNum = 11;BA.debugLine="Private BusyIndex As Int";
b4i_anotherprogressbar._busyindex = RemoteObject.createImmutable(0);__ref.setField("_busyindex",b4i_anotherprogressbar._busyindex);
 //BA.debugLineNum = 12;BA.debugLine="Private bc As BitmapCreator";
b4i_anotherprogressbar._bc = RemoteObject.createNew ("b4i_bitmapcreator");__ref.setField("_bc",b4i_anotherprogressbar._bc);
 //BA.debugLineNum = 13;BA.debugLine="Private mIV As B4XView";
b4i_anotherprogressbar._miv = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_miv",b4i_anotherprogressbar._miv);
 //BA.debugLineNum = 14;BA.debugLine="Private TransparentBrush As BCBrush";
b4i_anotherprogressbar._transparentbrush = RemoteObject.createNew ("_bcbrush");__ref.setField("_transparentbrush",b4i_anotherprogressbar._transparentbrush);
 //BA.debugLineNum = 15;BA.debugLine="Private Vertical As Boolean";
b4i_anotherprogressbar._vertical = RemoteObject.createImmutable(false);__ref.setField("_vertical",b4i_anotherprogressbar._vertical);
 //BA.debugLineNum = 16;BA.debugLine="Private CurrentValue As Float";
b4i_anotherprogressbar._currentvalue = RemoteObject.createImmutable(0.0f);__ref.setField("_currentvalue",b4i_anotherprogressbar._currentvalue);
 //BA.debugLineNum = 17;BA.debugLine="Public EmptyColor As Int = xui.Color_White";
b4i_anotherprogressbar._emptycolor = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_White");__ref.setField("_emptycolor",b4i_anotherprogressbar._emptycolor);
 //BA.debugLineNum = 18;BA.debugLine="Private EmptyBrush As BCBrush";
b4i_anotherprogressbar._emptybrush = RemoteObject.createNew ("_bcbrush");__ref.setField("_emptybrush",b4i_anotherprogressbar._emptybrush);
 //BA.debugLineNum = 19;BA.debugLine="Private mValue As Int";
b4i_anotherprogressbar._mvalue = RemoteObject.createImmutable(0);__ref.setField("_mvalue",b4i_anotherprogressbar._mvalue);
 //BA.debugLineNum = 20;BA.debugLine="Public Tag As Object";
b4i_anotherprogressbar._tag = RemoteObject.createNew ("NSObject");__ref.setField("_tag",b4i_anotherprogressbar._tag);
 //BA.debugLineNum = 21;BA.debugLine="Public ValueChangePerSecond As Float = 60";
b4i_anotherprogressbar._valuechangepersecond = BA.numberCast(float.class, 60);__ref.setField("_valuechangepersecond",b4i_anotherprogressbar._valuechangepersecond);
 //BA.debugLineNum = 22;BA.debugLine="Public CornerRadius As Int";
b4i_anotherprogressbar._cornerradius = RemoteObject.createImmutable(0);__ref.setField("_cornerradius",b4i_anotherprogressbar._cornerradius);
 //BA.debugLineNum = 23;BA.debugLine="Public BrushOffsetDelta As Int = 3";
b4i_anotherprogressbar._brushoffsetdelta = BA.numberCast(int.class, 3);__ref.setField("_brushoffsetdelta",b4i_anotherprogressbar._brushoffsetdelta);
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _designercreateview(RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) throws Exception{
try {
		Debug.PushSubsStack("DesignerCreateView (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,32);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_anotherprogressbar.class, "_setvalue:" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _props.runMethod(false,"GetDefault::",(Object)(RemoteObject.createImmutable(("Value"))),(Object)(RemoteObject.createImmutable((100)))))));
 BA.debugLineNum = 39;BA.debugLine="CurrentValue = mValue";
Debug.JustUpdateDeviceLine();
__ref.setField ("_currentvalue" /*RemoteObject*/ ,BA.numberCast(float.class, __ref.getField(true,"_mvalue" /*RemoteObject*/ )));
 BA.debugLineNum = 40;BA.debugLine="mBase.AddView(mIV, 0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((__ref.getField(false,"_miv" /*RemoteObject*/ )).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 41;BA.debugLine="mBase.AddView(lbl, 0, 0, mBase.Width, mBase.Heigh";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((_lbl).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_anotherprogressbar.class, "_base_resize::" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"))));
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,147);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,143);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Visible");
...
try {
		Debug.PushSubsStack("Initialize (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,26);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,151);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_mvalue" /*RemoteObject*/ ,BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Max::",(Object)(BA.numberCast(double.class, 0)),(Object)(b4i_main.__c.runMethod(true,"Min::",(Object)(BA.numberCast(double.class, 100)),(Object)(BA.numberCast(double.class, _v)))))));
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,155);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_anotherprogressbar.class, "_setvalue:" /*RemoteObject*/ ,(Object)(_v));
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,135);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_anotherprogressbar.class, "_busyloop" /*void*/ );
 };
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",9,__ref.getField(false, "bi"),__ref,102);
...
RemoteObject _template = RemoteObject.declareNull("b4i_bitmapcreator");
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_transparentbrush" /*RemoteObject*/ ,__ref.getField(false,"_bc" /*RemoteObject*/ ).runMethod(false,"_createbrushfromcolor:",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_Transparent"))));
...
Debug.JustUpdateDeviceLine();
_template = RemoteObject.createNew ("b4i_bitmapcreator");Debug.locals.put("Template", _template);
...
Debug.JustUpdateDeviceLine();
_bcolor.setField ("r",BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Min::",(Object)(BA.numberCast(double.class, 255)),(Object)(RemoteObject.solve(new RemoteObject[] {_bcolor.getField(true,"r"),RemoteObject.createImmutable(1.5)}, "*",0, 0)))));
 BA.debugLineNum = 110;BA.debugLine="bcolor.g = Min(255, bcolor.g * 1.5)";
Debug.JustUpdateDeviceLine();
_bcolor.setField ("g",BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Min::",(Object)(BA.numberCast(double.class, 255)),(Object)(RemoteObject.solve(new RemoteObject[] {_bcolor.getField(true,"g"),RemoteObject.createImmutable(1.5)}, "*",0, 0)))));
 BA.debugLineNum = 111;BA.debugLine="bcolor.b = Min(255, bcolor.b * 1.5)";
Debug.JustUpdateDeviceLine();
_bcolor.setField ("b",BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Min::",(Object)(BA.numberCast(double.class, 255)),(Object)(RemoteObject.solve(new RemoteObject[] {_bcolor.getField(true,"b"),RemoteObject.createImmutable(1.5)}, "*",0, 0)))));
...
Debug.JustUpdateDeviceLine();
_template.runVoidMethod ("_initialize:::",__ref.getField(false, "bi"),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width"),__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Scale")}, "/",0, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width"),__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Scale"),_width}, "/+",1, 0))));
 }else {
 BA.debugLineNum = 115;BA.debugLine="Template.Initialize(mBase.Height / xui.Scale + W";
Debug.JustUpdateDeviceLine();
_template.runVoidMethod ("_initialize:::",__ref.getField(false, "bi"),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Scale"),_width}, "/+",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"),__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Scale")}, "/",0, 0))));
 };
 BA.debugLineNum = 118;BA.debugLine="Template.DrawRect(Template.TargetRect, Background";
Debug.JustUpdateDeviceLine();
_template.runVoidMethod ("_drawrect::::",(Object)(_template.getField(false,"_targetrect")),(Object)(__ref.getField(true,"_backgroundcolor" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bc" /*RemoteObject*/ ).runVoidMethod ("_drawrectrounded:::::",(Object)(__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(false,"_targetrect")),(Object)(__ref.getField(true,"_backgroundcolor" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 15)));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_anotherprogressbar.class, "_setvisible:" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Visible")));
