...
public class b4i_b4xcolortemplate {
    public static RemoteObject myClass;
	public b4i_b4xcolortemplate() {
	}
    public static PCBA staticBA = new PCBA(null, b4i_b4xcolortemplate.class);
...
public static RemoteObject _bccolors = RemoteObject.declareNull("b4i_bitmapcreator");
public static RemoteObject _selectedh = RemoteObject.createImmutable(0.0f);
public static RemoteObject _selecteds = RemoteObject.createImmutable(0.0f);
public static RemoteObject _selectedv = RemoteObject.createImmutable(0.0f);
public static RemoteObject _devicescale = RemoteObject.createImmutable(0.0f);
public static RemoteObject _colorscale = RemoteObject.createImmutable(0.0f);
public static RemoteObject _tempbc = RemoteObject.declareNull("b4i_bitmapcreator");
public static RemoteObject _dont_change = RemoteObject.createImmutable(0);
public static RemoteObject _huebar = RemoteObject.declareNull("_colorpickerpart");
public static RemoteObject _colorpicker = RemoteObject.declareNull("_colorpickerpart");
public static RemoteObject _alphabar = RemoteObject.declareNull("_colorpickerpart");
