...
public class b4i_b4xdatetemplate_subs_0 {


public static RemoteObject  _btnmonth_click(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("btnMonth_Click (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,147);
...
Debug.JustUpdateDeviceLine();
_m = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(12),__ref.getField(true,"_month" /*RemoteObject*/ ),RemoteObject.createImmutable(1),BA.numberCast(double.class, _btn.runMethod(false,"Tag"))}, "+-+",3, 0));Debug.locals.put("m", _m);Debug.locals.put("m", _m);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_drawdays" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("btnYear_Click (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,141);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_year" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_year" /*RemoteObject*/ ),BA.numberCast(double.class, _btn.runMethod(false,"Tag"))}, "+",1, 0)));
...
b4i_b4xdatetemplate._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xdatetemplate._xui);
 //BA.debugLineNum = 3;BA.debugLine="Private month, year As Int";
b4i_b4xdatetemplate._month = RemoteObject.createImmutable(0);__ref.setField("_month",b4i_b4xdatetemplate._month);
b4i_b4xdatetemplate._year = RemoteObject.createImmutable(0);__ref.setField("_year",b4i_b4xdatetemplate._year);
 //BA.debugLineNum = 4;BA.debugLine="Private boxW, boxH As Float";
b4i_b4xdatetemplate._boxw = RemoteObject.createImmutable(0.0f);__ref.setField("_boxw",b4i_b4xdatetemplate._boxw);
b4i_b4xdatetemplate._boxh = RemoteObject.createImmutable(0.0f);__ref.setField("_boxh",b4i_b4xdatetemplate._boxh);
 //BA.debugLineNum = 5;BA.debugLine="Private vCorrection As Float";
b4i_b4xdatetemplate._vcorrection = RemoteObject.createImmutable(0.0f);__ref.setField("_vcorrection",b4i_b4xdatetemplate._vcorrection);
 //BA.debugLineNum = 6;BA.debugLine="Private tempSelectedDay As Int";
b4i_b4xdatetemplate._tempselectedday = RemoteObject.createImmutable(0);__ref.setField("_tempselectedday",b4i_b4xdatetemplate._tempselectedday);
 //BA.debugLineNum = 7;BA.debugLine="Private dayOfWeekOffset As Int";
b4i_b4xdatetemplate._dayofweekoffset = RemoteObject.createImmutable(0);__ref.setField("_dayofweekoffset",b4i_b4xdatetemplate._dayofweekoffset);
 //BA.debugLineNum = 8;BA.debugLine="Private daysInMonth As Int";
b4i_b4xdatetemplate._daysinmonth = RemoteObject.createImmutable(0);__ref.setField("_daysinmonth",b4i_b4xdatetemplate._daysinmonth);
 //BA.debugLineNum = 9;BA.debugLine="Private DaysPaneBg As B4XView";
b4i_b4xdatetemplate._dayspanebg = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_dayspanebg",b4i_b4xdatetemplate._dayspanebg);
 //BA.debugLineNum = 10;BA.debugLine="Private DaysPaneFg As B4XView";
b4i_b4xdatetemplate._dayspanefg = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_dayspanefg",b4i_b4xdatetemplate._dayspanefg);
 //BA.debugLineNum = 11;BA.debugLine="Private cvs As B4XCanvas";
b4i_b4xdatetemplate._cvs = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvs",b4i_b4xdatetemplate._cvs);
 //BA.debugLineNum = 12;BA.debugLine="Private cvsBackground As B4XCanvas";
b4i_b4xdatetemplate._cvsbackground = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvsbackground",b4i_b4xdatetemplate._cvsbackground);
 //BA.debugLineNum = 13;BA.debugLine="Private selectedDate As Long";
b4i_b4xdatetemplate._selecteddate = RemoteObject.createImmutable(0L);__ref.setField("_selecteddate",b4i_b4xdatetemplate._selecteddate);
 //BA.debugLineNum = 14;BA.debugLine="Private selectedYear, selectedMonth, selectedDay";
b4i_b4xdatetemplate._selectedyear = RemoteObject.createImmutable(0);__ref.setField("_selectedyear",b4i_b4xdatetemplate._selectedyear);
b4i_b4xdatetemplate._selectedmonth = RemoteObject.createImmutable(0);__ref.setField("_selectedmonth",b4i_b4xdatetemplate._selectedmonth);
b4i_b4xdatetemplate._selectedday = RemoteObject.createImmutable(0);__ref.setField("_selectedday",b4i_b4xdatetemplate._selectedday);
 //BA.debugLineNum = 15;BA.debugLine="Public HighlightedColor As Int = 0xFF001BBD";
b4i_b4xdatetemplate._highlightedcolor = BA.numberCast(int.class, 0xff001bbd);__ref.setField("_highlightedcolor",b4i_b4xdatetemplate._highlightedcolor);
 //BA.debugLineNum = 16;BA.debugLine="Public SelectedColor As Int = 0xFF0BA29B";
b4i_b4xdatetemplate._selectedcolor = BA.numberCast(int.class, 0xff0ba29b);__ref.setField("_selectedcolor",b4i_b4xdatetemplate._selectedcolor);
 //BA.debugLineNum = 17;BA.debugLine="Public DaysInMonthColor As Int = xui.Color_White";
b4i_b4xdatetemplate._daysinmonthcolor = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_White");__ref.setField("_daysinmonthcolor",b4i_b4xdatetemplate._daysinmonthcolor);
 //BA.debugLineNum = 18;BA.debugLine="Public DaysInWeekColor As Int = xui.Color_Gray";
b4i_b4xdatetemplate._daysinweekcolor = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_Gray");__ref.setField("_daysinweekcolor",b4i_b4xdatetemplate._daysinweekcolor);
 //BA.debugLineNum = 19;BA.debugLine="Private cvsDays As B4XCanvas";
b4i_b4xdatetemplate._cvsdays = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvsdays",b4i_b4xdatetemplate._cvsdays);
 //BA.debugLineNum = 20;BA.debugLine="Private DaysTitlesPane As B4XView";
b4i_b4xdatetemplate._daystitlespane = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_daystitlespane",b4i_b4xdatetemplate._daystitlespane);
 //BA.debugLineNum = 21;BA.debugLine="Public FirstDay As Int = 0";
b4i_b4xdatetemplate._firstday = BA.numberCast(int.class, 0);__ref.setField("_firstday",b4i_b4xdatetemplate._firstday);
 //BA.debugLineNum = 22;BA.debugLine="Public MinYear = 1970, MaxYear = 2030 As Int";
b4i_b4xdatetemplate._minyear = BA.numberCast(int.class, 1970);__ref.setField("_minyear",b4i_b4xdatetemplate._minyear);
b4i_b4xdatetemplate._maxyear = BA.numberCast(int.class, 2030);__ref.setField("_maxyear",b4i_b4xdatetemplate._maxyear);
 //BA.debugLineNum = 23;BA.debugLine="Public btnMonthLeft As B4XView";
b4i_b4xdatetemplate._btnmonthleft = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_btnmonthleft",b4i_b4xdatetemplate._btnmonthleft);
 //BA.debugLineNum = 24;BA.debugLine="Public btnMonthRight As B4XView";
b4i_b4xdatetemplate._btnmonthright = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_btnmonthright",b4i_b4xdatetemplate._btnmonthright);
 //BA.debugLineNum = 25;BA.debugLine="Public btnYearLeft As B4XView";
b4i_b4xdatetemplate._btnyearleft = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_btnyearleft",b4i_b4xdatetemplate._btnyearleft);
 //BA.debugLineNum = 26;BA.debugLine="Public btnYearRight As B4XView";
b4i_b4xdatetemplate._btnyearright = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_btnyearright",b4i_b4xdatetemplate._btnyearright);
 //BA.debugLineNum = 27;BA.debugLine="Public lblMonth As B4XView";
b4i_b4xdatetemplate._lblmonth = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_lblmonth",b4i_b4xdatetemplate._lblmonth);
 //BA.debugLineNum = 28;BA.debugLine="Public lblYear As B4XView";
b4i_b4xdatetemplate._lblyear = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_lblyear",b4i_b4xdatetemplate._lblyear);
 //BA.debugLineNum = 29;BA.debugLine="Private pnlDialog As B4XView";
b4i_b4xdatetemplate._pnldialog = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_pnldialog",b4i_b4xdatetemplate._pnldialog);
 //BA.debugLineNum = 30;BA.debugLine="Private months As List";
b4i_b4xdatetemplate._months = RemoteObject.createNew ("B4IList");__ref.setField("_months",b4i_b4xdatetemplate._months);
 //BA.debugLineNum = 31;BA.debugLine="Private mDialog As B4XDialog";
b4i_b4xdatetemplate._mdialog = RemoteObject.createNew ("b4i_b4xdialog");__ref.setField("_mdialog",b4i_b4xdatetemplate._mdialog);
...
try {
		Debug.PushSubsStack("DaysPaneFg_Touch (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,154);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_handlemouse:::" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _x)),(Object)(BA.numberCast(double.class, _y)),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_action,BA.numberCast(double.class, _p.runMethod(true,"TOUCH_ACTION_UP"))))));
...
try {
		Debug.PushSubsStack("DialogClosed (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,176);
...
try {
		Debug.PushSubsStack("DrawBox (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,82);
...
Debug.JustUpdateDeviceLine();
_c.runVoidMethod ("DrawRect::::",(Object)(_r),(Object)(_clr),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 1))))));
...
try {
		Debug.PushSubsStack("DrawDays (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,57);
...
RemoteObject _daysfont = RemoteObject.declareNull("B4XFont");
int _day = 0;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvsbackground" /*RemoteObject*/ ).runVoidMethod ("ClearRect:",(Object)(__ref.getField(false,"_cvsbackground" /*RemoteObject*/ ).runMethod(false,"TargetRect")));
 BA.debugLineNum = 64;BA.debugLine="Dim firstDayOfMonth As Long = DateUtils.setDate(y";
Debug.JustUpdateDeviceLine();
_firstdayofmonth = RemoteObject.solve(new RemoteObject[] {b4i_b4xdatetemplate._dateutils.runMethod(true,"_setdate:::",(Object)(__ref.getField(true,"_year" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_month" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 1))),RemoteObject.createImmutable(1)}, "-",1, 2);Debug.locals.put("firstDayOfMonth", _firstdayofmonth);Debug.locals.put("firstDayOfMonth", _firstdayofmonth);
 BA.debugLineNum = 65;BA.debugLine="dayOfWeekOffset = (7 + DateTime.GetDayOfWeek(firs";
Debug.JustUpdateDeviceLine();
__ref.setField ("_dayofweekoffset" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(7),b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"GetDayOfWeek:",(Object)(_firstdayofmonth)),__ref.getField(true,"_firstday" /*RemoteObject*/ )}, "+-",2, 1)),RemoteObject.createImmutable(7)}, "%",0, 1));
 BA.debugLineNum = 66;BA.debugLine="daysInMonth = DateUtils.NumberOfDaysInMonth(month";
Debug.JustUpdateDeviceLine();
__ref.setField ("_daysinmonth" /*RemoteObject*/ ,b4i_b4xdatetemplate._dateutils.runMethod(true,"_numberofdaysinmonth::",(Object)(__ref.getField(true,"_month" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_year" /*RemoteObject*/ ))));
...
{
final int step14 = 1;
final int limit14 = __ref.getField(true,"_daysinmonth" /*RemoteObject*/ ).<Number>get().intValue();
_day = 1 ;
...
try {
		Debug.PushSubsStack("getDate (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,159);
...
try {
		Debug.PushSubsStack("HandleMouse (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,114);
...
Debug.JustUpdateDeviceLine();
if (_validday.getBoolean()) { 
 BA.debugLineNum = 123;BA.debugLine="DrawBox(cvsBackground, HighlightedColor, boxX,";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_drawbox::::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_cvsbackground" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_highlightedcolor" /*RemoteObject*/ )),(Object)(_boxx),(Object)(_boxy));
 };
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_selectday:" /*RemoteObject*/ ,(Object)(_newselectedday));
 BA.debugLineNum = 129;BA.debugLine="Hide";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_hide" /*RemoteObject*/ );
 };
 };
...
try {
		Debug.PushSubsStack("Hide (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,136);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (b4i_b4xdialog.class, "_close:" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"DialogResponse_Positive")));
...
try {
		Debug.PushSubsStack("Initialize (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,34);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_pnldialog" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable(""))));
 BA.debugLineNum = 36;BA.debugLine="pnlDialog.SetLayoutAnimated(0, 0, 0, 320dip,300di";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_pnldialog" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 320))))),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 300))))));
 BA.debugLineNum = 37;BA.debugLine="pnlDialog.LoadLayout(\"DateTemplate\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_pnldialog" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout::",(Object)(RemoteObject.createImmutable("DateTemplate")),__ref.getField(false, "bi"));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_month" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"GetMonth:",(Object)(b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"))));
 BA.debugLineNum = 40;BA.debugLine="year = DateTime.GetYear(DateTime.Now)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_year" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"GetYear:",(Object)(b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"))));
 BA.debugLineNum = 41;BA.debugLine="months = DateUtils.GetMonthsNames";
Debug.JustUpdateDeviceLine();
__ref.setField ("_months" /*RemoteObject*/ ,b4i_b4xdatetemplate._dateutils.runMethod(false,"_getmonthsnames"));
 BA.debugLineNum = 42;BA.debugLine="selectedDate = DateTime.Now";
Debug.JustUpdateDeviceLine();
__ref.setField ("_selecteddate" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"));
 BA.debugLineNum = 43;BA.debugLine="setDate(selectedDate)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_setdate:" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_selecteddate" /*RemoteObject*/ )));
 BA.debugLineNum = 44;BA.debugLine="cvs.Initialize(DaysPaneFg)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("Initialize:",(Object)(((__ref.getField(false,"_dayspanefg" /*RemoteObject*/ )).getObject())));
 BA.debugLineNum = 45;BA.debugLine="cvsBackground.Initialize(DaysPaneBg)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvsbackground" /*RemoteObject*/ ).runVoidMethod ("Initialize:",(Object)(((__ref.getField(false,"_dayspanebg" /*RemoteObject*/ )).getObject())));
 BA.debugLineNum = 46;BA.debugLine="boxW = cvs.TargetRect.Width / 7";
Debug.JustUpdateDeviceLine();
__ref.setField ("_boxw" /*RemoteObject*/ ,BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Width"),RemoteObject.createImmutable(7)}, "/",0, 0)));
 BA.debugLineNum = 47;BA.debugLine="boxH = cvs.TargetRect.Height / 6";
Debug.JustUpdateDeviceLine();
__ref.setField ("_boxh" /*RemoteObject*/ ,BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Height"),RemoteObject.createImmutable(6)}, "/",0, 0)));
 BA.debugLineNum = 48;BA.debugLine="vCorrection = 5dip";
Debug.JustUpdateDeviceLine();
__ref.setField ("_vcorrection" /*RemoteObject*/ ,BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)))));
 BA.debugLineNum = 49;BA.debugLine="cvsDays.Initialize(DaysTitlesPane)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvsdays" /*RemoteObject*/ ).runVoidMethod ("Initialize:",(Object)(((__ref.getField(false,"_daystitlespane" /*RemoteObject*/ )).getObject())));
...
try {
		Debug.PushSubsStack("SelectDay (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,106);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_selecteddate" /*RemoteObject*/ ,b4i_b4xdatetemplate._dateutils.runMethod(true,"_setdate:::",(Object)(__ref.getField(true,"_year" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_month" /*RemoteObject*/ )),(Object)(_day)));
...
try {
		Debug.PushSubsStack("setDate (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,93);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_lblyear" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),b4i_main.__c.runMethod(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_year" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"GetYear:",(Object)(_date)));
 BA.debugLineNum = 100;BA.debugLine="month = DateTime.GetMonth(date)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_month" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"GetMonth:",(Object)(_date)));
 BA.debugLineNum = 101;BA.debugLine="SelectDay(DateTime.GetDayOfMonth(date))";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xdatetemplate.class, "_selectday:" /*RemoteObject*/ ,(Object)(b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"GetDayOfMonth:",(Object)(_date))));
...
try {
		Debug.PushSubsStack("Show (b4xdatetemplate) ","b4xdatetemplate",13,__ref.getField(false, "bi"),__ref,163);
if (RapidSub.canDelegate("show")) { return __ref.runUserSub(false, "b4xdatetemplate","show", __ref, _dialog);}
RemoteObject _days = RemoteObject.declareNull("B4IList");
RemoteObject _daysfont = RemoteObject.declareNull("B4XFont");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
_days = RemoteObject.createNew ("B4IList");
_days = b4i_b4xdatetemplate._dateutils.runMethod(false,"_getdaysnames");Debug.locals.put("days", _days);Debug.locals.put("days", _days);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvsdays" /*RemoteObject*/ ).runVoidMethod ("ClearRect:",(Object)(__ref.getField(false,"_cvsdays" /*RemoteObject*/ ).runMethod(false,"TargetRect")));
 BA.debugLineNum = 167;BA.debugLine="For i = FirstDay To FirstDay + 7 - 1";
Debug.JustUpdateDeviceLine();
{
final int step4 = 1;
final int limit4 = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_firstday" /*RemoteObject*/ ),RemoteObject.createImmutable(7),RemoteObject.createImmutable(1)}, "+-",2, 1).<Number>get().intValue();
_i = __ref.getField(true,"_firstday" /*RemoteObject*/ ).<Number>get().intValue() ;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvsdays" /*RemoteObject*/ ).runVoidMethod ("DrawText::::::",(Object)(_d.runMethod(true,"SubString2::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 2)))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),__ref.getField(true,"_firstday" /*RemoteObject*/ ),RemoteObject.createImmutable(0.5)}, "-+",2, 0)),__ref.getField(true,"_boxw" /*RemoteObject*/ )}, "*",0, 0))),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 20))))),(Object)(_daysfont),(Object)(__ref.getField(true,"_daysinweekcolor" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("CENTER")));
 }
}Debug.locals.put("i", _i);
;
