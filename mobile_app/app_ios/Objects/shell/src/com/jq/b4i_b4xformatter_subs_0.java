...
public class b4i_b4xformatter_subs_0 {
...
try {
		Debug.PushSubsStack("AddFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,61);
...
RemoteObject _factor = RemoteObject.createImmutable(0.0);
...
Debug.JustUpdateDeviceLine();
_factor = b4i_main.__c.runMethod(true,"Power::",(Object)(BA.numberCast(double.class, 10)),(Object)(BA.numberCast(double.class, -(double) (0 + _data.getField(true,"MaximumFractions" /*RemoteObject*/ ).<Number>get().intValue()))));Debug.locals.put("factor", _factor);Debug.locals.put("factor", _factor);
 BA.debugLineNum = 63;BA.debugLine="If IncludeEdges = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_includeedges,b4i_main.__c.runMethod(true,"False"))) { 
...
b4i_b4xformatter._formats = RemoteObject.createNew ("B4IList");__ref.setField("_formats",b4i_b4xformatter._formats);
 //BA.debugLineNum = 7;BA.debugLine="Public Const MAX_VALUE = 0x7fffffff, MIN_VALUE =";
b4i_b4xformatter._max_value = BA.numberCast(int.class, 0x7fffffff);__ref.setField("_max_value",b4i_b4xformatter._max_value);
b4i_b4xformatter._min_value = BA.numberCast(int.class, 0x80000000);__ref.setField("_min_value",b4i_b4xformatter._min_value);
 //BA.debugLineNum = 8;BA.debugLine="Private xui As XUI";
b4i_b4xformatter._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xformatter._xui);
 //BA.debugLineNum = 9;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _copyformatdata(RemoteObject __ref,RemoteObject _data) throws Exception{
try {
		Debug.PushSubsStack("CopyFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,36);
if (RapidSub.canDelegate("copyformatdata")) { return __ref.runUserSub(false, "b4xformatter","copyformatdata", __ref, _data);}
RemoteObject _d = RemoteObject.declareNull("_b4xformatdata");
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
_d = RemoteObject.createNew ("_b4xformatdata");Debug.locals.put("d", _d);
...
Debug.JustUpdateDeviceLine();
if (_data.getField(false,"FormatFont" /*RemoteObject*/ ).runMethod(true,"IsInitialized").getBoolean()) { 
 BA.debugLineNum = 41;BA.debugLine="d.FormatFont = xui.CreateFont(Data.FormatFont.To";
Debug.JustUpdateDeviceLine();
_d.setField ("FormatFont" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateFont::",(Object)(((_data.getField(false,"FormatFont" /*RemoteObject*/ ).runMethod(false,"ToNativeFont")).getObject())),(Object)(_data.getField(false,"FormatFont" /*RemoteObject*/ ).runMethod(true,"Size"))));
 };
...
try {
		Debug.PushSubsStack("CreateDefaultFormat (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,17);
...
try {
		Debug.PushSubsStack("Format (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,88);
if (RapidSub.canDelegate("format")) { return __ref.runUserSub(false, "b4xformatter","format", __ref, _number);}
RemoteObject _data = RemoteObject.declareNull("_b4xformatdata");
...
RemoteObject _frac = RemoteObject.createImmutable(0.0);
...
Debug.JustUpdateDeviceLine();
_data = __ref.runClassMethod (b4i_b4xformatter.class, "_getformatdata:" /*RemoteObject*/ ,(Object)(_number));Debug.locals.put("data", _data);Debug.locals.put("data", _data);
...
Debug.JustUpdateDeviceLine();
_numberstartindex = _sb.runMethod(true,"Length");Debug.locals.put("NumberStartIndex", _numberstartindex);Debug.locals.put("NumberStartIndex", _numberstartindex);
 BA.debugLineNum = 95;BA.debugLine="Dim factor As Double = Power(10, -data.MaximumFra";
Debug.JustUpdateDeviceLine();
_factor = RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(true,"Power::",(Object)(BA.numberCast(double.class, 10)),(Object)(BA.numberCast(double.class, -(double) (0 + _data.getField(true,"MaximumFractions" /*RemoteObject*/ ).<Number>get().intValue())-(double) (0 + 1)))),RemoteObject.createImmutable(5)}, "*",0, 0);Debug.locals.put("factor", _factor);Debug.locals.put("factor", _factor);
 BA.debugLineNum = 96;BA.debugLine="If Number < -factor And data.RemoveMinusSign = Fa";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",_number,BA.numberCast(double.class, -_factor.<Number>get().doubleValue())) && RemoteObject.solveBoolean("=",_data.getField(true,"RemoveMinusSign" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
_number = RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(true,"Abs:",(Object)(_number)),_factor}, "+",1, 0);Debug.locals.put("Number", _number);
...
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"Length"),_numberstartindex}, "-",1, 1),BA.numberCast(double.class, _data.getField(true,"MinimumIntegers" /*RemoteObject*/ )))) {
...
Debug.JustUpdateDeviceLine();
_fracstartindex = _sb.runMethod(true,"Length");Debug.locals.put("FracStartIndex", _fracstartindex);Debug.locals.put("FracStartIndex", _fracstartindex);
...
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Remove::",(Object)(RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"Length"),_lastzerocount}, "-",1, 1)),(Object)(_sb.runMethod(true,"Length")));
...
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"Length"),_fracstartindex}, "-",1, 1),BA.numberCast(double.class, _data.getField(true,"MinimumFractions" /*RemoteObject*/ )))) {
...
Debug.JustUpdateDeviceLine();
_lastzerocount = BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Min::",(Object)(BA.numberCast(double.class, _lastzerocount)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_sb.runMethod(true,"Length"),_fracstartindex,_data.getField(true,"MinimumFractions" /*RemoteObject*/ )}, "--",2, 1)))));Debug.locals.put("LastZeroCount", _lastzerocount);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_sb.runMethod(true,"Length"),BA.numberCast(double.class, _fracstartindex))) { 
...
try {
		Debug.PushSubsStack("FormatLabel (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,145);
...
Debug.JustUpdateDeviceLine();
_label.runMethod(true,"setText:",__ref.runClassMethod (b4i_b4xformatter.class, "_format:" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _number))));
 BA.debugLineNum = 147;BA.debugLine="Dim data As B4XFormatData = GetFormatData(Number)";
Debug.JustUpdateDeviceLine();
_data = __ref.runClassMethod (b4i_b4xformatter.class, "_getformatdata:" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _number)));Debug.locals.put("data", _data);Debug.locals.put("data", _data);
...
try {
		Debug.PushSubsStack("GetDefaultFormat (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,74);
...
try {
		Debug.PushSubsStack("GetFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,79);
...
final int step1 = -1;
final int limit1 = 1;
_i = RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_formats" /*RemoteObject*/ ).runMethod(true,"Size"),RemoteObject.createImmutable(1)}, "-",1, 1).<Number>get().intValue() ;
...
try {
		Debug.PushSubsStack("Initialize (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,11);
...
Debug.JustUpdateDeviceLine();
_d = __ref.runClassMethod (b4i_b4xformatter.class, "_createdefaultformat" /*RemoteObject*/ );Debug.locals.put("d", _d);Debug.locals.put("d", _d);
 BA.debugLineNum = 14;BA.debugLine="AddFormatData(d, MIN_VALUE, MAX_VALUE, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xformatter.class, "_addformatdata::::" /*RemoteObject*/ ,(Object)(_d),(Object)(BA.numberCast(double.class, __ref.getField(true,"_min_value" /*RemoteObject*/ ))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_max_value" /*RemoteObject*/ ))),(Object)(b4i_main.__c.runMethod(true,"True")));
...
try {
		Debug.PushSubsStack("NewFormatData (b4xformatter) ","b4xformatter",25,__ref.getField(false, "bi"),__ref,30);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4i_b4xformatter.class, "_copyformatdata:" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4i_b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ )));
