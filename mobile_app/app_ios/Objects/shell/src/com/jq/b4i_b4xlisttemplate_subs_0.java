...
public class b4i_b4xlisttemplate_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 1;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 2;BA.debugLine="Private xui As XUI";
b4i_b4xlisttemplate._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xlisttemplate._xui);
 //BA.debugLineNum = 3;BA.debugLine="Public mBase As B4XView";
b4i_b4xlisttemplate._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_b4xlisttemplate._mbase);
 //BA.debugLineNum = 4;BA.debugLine="Public CustomListView1 As CustomListView";
b4i_b4xlisttemplate._customlistview1 = RemoteObject.createNew ("b4i_customlistview");__ref.setField("_customlistview1",b4i_b4xlisttemplate._customlistview1);
 //BA.debugLineNum = 5;BA.debugLine="Public Options As List";
b4i_b4xlisttemplate._options = RemoteObject.createNew ("B4IList");__ref.setField("_options",b4i_b4xlisttemplate._options);
 //BA.debugLineNum = 6;BA.debugLine="Public SelectedItem As String";
b4i_b4xlisttemplate._selecteditem = RemoteObject.createImmutable("");__ref.setField("_selecteditem",b4i_b4xlisttemplate._selecteditem);
 //BA.debugLineNum = 7;BA.debugLine="Private xDialog As B4XDialog";
b4i_b4xlisttemplate._xdialog = RemoteObject.createNew ("b4i_b4xdialog");__ref.setField("_xdialog",b4i_b4xlisttemplate._xdialog);
 //BA.debugLineNum = 8;BA.debugLine="Public AllowMultiSelection As Boolean";
b4i_b4xlisttemplate._allowmultiselection = RemoteObject.createImmutable(false);__ref.setField("_allowmultiselection",b4i_b4xlisttemplate._allowmultiselection);
 //BA.debugLineNum = 9;BA.debugLine="Public SelectionColor As Int = 0xAA0086FF";
b4i_b4xlisttemplate._selectioncolor = BA.numberCast(int.class, 0xaa0086ff);__ref.setField("_selectioncolor",b4i_b4xlisttemplate._selectioncolor);
 //BA.debugLineNum = 10;BA.debugLine="Public SelectedItems As List";
b4i_b4xlisttemplate._selecteditems = RemoteObject.createNew ("B4IList");__ref.setField("_selecteditems",b4i_b4xlisttemplate._selecteditems);
 //BA.debugLineNum = 11;BA.debugLine="Public MultiSelectionMinimum As Int = 0";
b4i_b4xlisttemplate._multiselectionminimum = BA.numberCast(int.class, 0);__ref.setField("_multiselectionminimum",b4i_b4xlisttemplate._multiselectionminimum);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,76);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_allowmultiselection" /*RemoteObject*/ ).getBoolean()) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xlisttemplate.class, "_selectitem::" /*RemoteObject*/ ,(Object)(_item),(Object)(b4i_main.__c.runMethod(true,"True")));
 }else {
...
try {
		Debug.PushSubsStack("DialogClosed (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,37);
...
try {
		Debug.PushSubsStack("Initialize (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,14);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout::",(Object)(RemoteObject.createImmutable("ListTemplate")),__ref.getField(false, "bi"));
...
try {
		Debug.PushSubsStack("Resize (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,31);
...
try {
		Debug.PushSubsStack("SelectItem (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,59);
...
Debug.JustUpdateDeviceLine();
if (_toggle.getBoolean()) { 
_selected = b4i_main.__c.runMethod(true,"Not:",(Object)(_selected));Debug.locals.put("Selected", _selected);};
 BA.debugLineNum = 63;BA.debugLine="If Selected Then";
Debug.JustUpdateDeviceLine();
if (_selected.getBoolean()) { 
 BA.debugLineNum = 64;BA.debugLine="If Not(Toggle) Then Item.Panel.Color = Selection";
Debug.JustUpdateDeviceLine();
if (b4i_main.__c.runMethod(true,"Not:",(Object)(_toggle)).getBoolean()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (b4i_b4xdialog.class, "_setbuttonstate::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"DialogResponse_Positive")),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",__ref.getField(false,"_selecteditems" /*RemoteObject*/ ).runMethod(true,"Size"),BA.numberCast(double.class, __ref.getField(true,"_multiselectionminimum" /*RemoteObject*/ ))))));
...
try {
		Debug.PushSubsStack("Show (b4xlisttemplate) ","b4xlisttemplate",17,__ref.getField(false, "bi"),__ref,41);
...
public ResumableSub_Show(b4i_b4xlisttemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
RemoteObject _opt = RemoteObject.declareNull("NSObject");
int _i = 0;
RemoteObject _item = RemoteObject.declareNull("_clvitem");
RemoteObject group3;
int index3;
...
index3 = 0;
groupLen3 = group3.runMethod(true,"Size").<Integer>get();
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xlisttemplate", "show"),BA.numberCast(int.class, 20));
this.state = 14;
return;
case 14:
//C
...
this.state = 10;
step8 = 1;
limit8 = RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(true,"_getsize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Number>get().intValue();
_i = 0 ;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xlisttemplate.class, "_selectitem::" /*RemoteObject*/ ,(Object)(_item),(Object)(b4i_main.__c.runMethod(true,"False")));
 if (true) break;
if (true) break;
...
Debug.JustUpdateDeviceLine();
_dialog.runClassMethod (b4i_b4xdialog.class, "_internaladdstubtoclvifneeded::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(true,"_defaulttextbackgroundcolor")));
