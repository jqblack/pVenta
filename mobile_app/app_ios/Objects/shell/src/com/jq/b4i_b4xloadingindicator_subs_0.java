...
public class b4i_b4xloadingindicator_subs_0 {


public static RemoteObject  _base_resize(RemoteObject __ref,RemoteObject _width,RemoteObject _height) throws Exception{
try {
		Debug.PushSubsStack("Base_Resize (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,37);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xloadingindicator.class, "_mainloop" /*void*/ );
...
b4i_b4xloadingindicator._meventname = RemoteObject.createImmutable("");__ref.setField("_meventname",b4i_b4xloadingindicator._meventname);
 //BA.debugLineNum = 9;BA.debugLine="Private mCallBack As Object 'ignore";
b4i_b4xloadingindicator._mcallback = RemoteObject.createNew ("NSObject");__ref.setField("_mcallback",b4i_b4xloadingindicator._mcallback);
 //BA.debugLineNum = 10;BA.debugLine="Public mBase As B4XView 'ignore";
b4i_b4xloadingindicator._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_b4xloadingindicator._mbase);
 //BA.debugLineNum = 11;BA.debugLine="Private xui As XUI 'ignore";
b4i_b4xloadingindicator._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xloadingindicator._xui);
 //BA.debugLineNum = 12;BA.debugLine="Private clr As Int";
b4i_b4xloadingindicator._clr = RemoteObject.createImmutable(0);__ref.setField("_clr",b4i_b4xloadingindicator._clr);
 //BA.debugLineNum = 13;BA.debugLine="Private index As Int";
b4i_b4xloadingindicator._index = RemoteObject.createImmutable(0);__ref.setField("_index",b4i_b4xloadingindicator._index);
 //BA.debugLineNum = 14;BA.debugLine="Private cvs As B4XCanvas";
b4i_b4xloadingindicator._cvs = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvs",b4i_b4xloadingindicator._cvs);
 //BA.debugLineNum = 15;BA.debugLine="Private duration As Int";
b4i_b4xloadingindicator._duration = RemoteObject.createImmutable(0);__ref.setField("_duration",b4i_b4xloadingindicator._duration);
 //BA.debugLineNum = 16;BA.debugLine="Private DrawingSubName As String";
b4i_b4xloadingindicator._drawingsubname = RemoteObject.createImmutable("");__ref.setField("_drawingsubname",b4i_b4xloadingindicator._drawingsubname);
 //BA.debugLineNum = 17;BA.debugLine="Public Tag As Object";
b4i_b4xloadingindicator._tag = RemoteObject.createNew ("NSObject");__ref.setField("_tag",b4i_b4xloadingindicator._tag);
 //BA.debugLineNum = 18;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _designercreateview(RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) throws Exception{
try {
		Debug.PushSubsStack("DesignerCreateView (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,26);
...
Debug.JustUpdateDeviceLine();
b4i_b4xloadingindicator._duration = BA.numberCast(int.class, _props.runMethod(false,"Get:",(Object)((RemoteObject.createImmutable("Duration")))));__ref.setField("_duration",b4i_b4xloadingindicator._duration);
...
try {
		Debug.PushSubsStack("Draw_Arc1 (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,105);
...
RemoteObject _r = RemoteObject.createImmutable(0.0f);
...
Debug.JustUpdateDeviceLine();
_r = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)))}, "-",1, 0));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("InitializeArc:::::",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX")),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY")),(Object)(_r),(Object)(BA.numberCast(float.class, -(double) (0 + 90))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_progress,RemoteObject.createImmutable(2),RemoteObject.createImmutable(360)}, "**",0, 0))));
 }else {
 BA.debugLineNum = 111;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("InitializeArc:::::",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX")),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY")),(Object)(_r),(Object)(BA.numberCast(float.class, -(double) (0 + 90))),(Object)(BA.numberCast(float.class, -(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(1),_progress}, "-",1, 0)).<Number>get().doubleValue()*(double) (0 + 2)*(double) (0 + 360))));
 };
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawRect::::",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect")),(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
...
try {
		Debug.PushSubsStack("Draw_Arc2 (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,118);
...
try {
		Debug.PushSubsStack("Draw_FiveLines1 (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,95);
...
Debug.JustUpdateDeviceLine();
_minr = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 10)));Debug.locals.put("MinR", _minr);Debug.locals.put("MinR", _minr);
 BA.debugLineNum = 97;BA.debugLine="Dim MaxR As Int = cvs.TargetRect.Height / 2";
Debug.JustUpdateDeviceLine();
_maxr = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Height"),RemoteObject.createImmutable(2)}, "/",0, 0));Debug.locals.put("MaxR", _maxr);Debug.locals.put("MaxR", _maxr);
 BA.debugLineNum = 98;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
Debug.JustUpdateDeviceLine();
_dx = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Width"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2)))}, "-",1, 0)),RemoteObject.createImmutable(5)}, "/",0, 0));Debug.locals.put("dx", _dx);Debug.locals.put("dx", _dx);
...
Debug.JustUpdateDeviceLine();
_r = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_minr,_maxr,RemoteObject.createImmutable(2),_maxr,RemoteObject.createImmutable(2),b4i_main.__c.runMethod(true,"SinD:",(Object)(RemoteObject.solve(new RemoteObject[] {_progress,RemoteObject.createImmutable(360),RemoteObject.createImmutable(30),RemoteObject.createImmutable(_i)}, "*-*",1, 0)))}, "+/+/*",2, 0));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 101;BA.debugLine="cvs.DrawLine(2dip + i * dx, cvs.TargetRect.Cente";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawLine::::::",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable(_i),_dx}, "+*",1, 1))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY"),_r}, "-",1, 0))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable(_i),_dx}, "+*",1, 1))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY"),_r}, "+",1, 0))),(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 4))))));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("Draw_PacMan (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,131);
...
Debug.JustUpdateDeviceLine();
_dotr = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)));Debug.locals.put("DotR", _dotr);Debug.locals.put("DotR", _dotr);
 BA.debugLineNum = 133;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.Width - DotR - Prog";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle::::::",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Width"),_dotr,_progress,(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 0))}, "--*",2, 0))),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY")),(Object)(BA.numberCast(float.class, _dotr)),(Object)(__ref.runClassMethod (b4i_b4xloadingindicator.class, "_setalpha::" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(255),RemoteObject.createImmutable(200),_progress}, "-*",1, 0))))),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 134;BA.debugLine="Dim p As B4XPath";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("B4XPath");Debug.locals.put("p", _p);
 BA.debugLineNum = 135;BA.debugLine="Dim angle As Int = 70 * SinD(Progress * 180)";
Debug.JustUpdateDeviceLine();
_angle = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(70),b4i_main.__c.runMethod(true,"SinD:",(Object)(RemoteObject.solve(new RemoteObject[] {_progress,RemoteObject.createImmutable(180)}, "*",0, 0)))}, "*",0, 0));Debug.locals.put("angle", _angle);Debug.locals.put("angle", _angle);
 BA.debugLineNum = 136;BA.debugLine="Dim cx As Int = cvs.TargetRect.CenterX - 5dip";
Debug.JustUpdateDeviceLine();
_cx = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)))}, "-",1, 0));Debug.locals.put("cx", _cx);Debug.locals.put("cx", _cx);
 BA.debugLineNum = 137;BA.debugLine="Dim cy As Int = cvs.TargetRect.CenterY";
Debug.JustUpdateDeviceLine();
_cy = BA.numberCast(int.class, __ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY"));Debug.locals.put("cy", _cy);Debug.locals.put("cy", _cy);
 BA.debugLineNum = 138;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
Debug.JustUpdateDeviceLine();
_r = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)))}, "-",1, 0));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle::::::",(Object)(BA.numberCast(float.class, _cx)),(Object)(BA.numberCast(float.class, _cy)),(Object)(BA.numberCast(float.class, _r)),(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 }else {
 BA.debugLineNum = 142;BA.debugLine="p.InitializeArc(cx, cy , r, -angle / 2, -(360-an";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("InitializeArc:::::",(Object)(BA.numberCast(float.class, _cx)),(Object)(BA.numberCast(float.class, _cy)),(Object)(BA.numberCast(float.class, _r)),(Object)(BA.numberCast(float.class, -(double) (0 + _angle.<Number>get().intValue())/(double)(double) (0 + 2))),(Object)(BA.numberCast(float.class, -(double) (0 + (RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(360),_angle}, "-",1, 1)).<Number>get().intValue()))));
...
try {
		Debug.PushSubsStack("Draw_SingleCircle (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,85);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle::::::",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX")),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX"),_progress}, "*",0, 0))),(Object)(__ref.runClassMethod (b4i_b4xloadingindicator.class, "_setalpha::" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(255),RemoteObject.createImmutable(255),_progress}, "-*",1, 0))))),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles1 (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,66);
...
RemoteObject _maxr = RemoteObject.createImmutable(0.0f);
RemoteObject _r = RemoteObject.createImmutable(0.0f);
int _i = 0;
...
Debug.JustUpdateDeviceLine();
_maxr = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Width"),RemoteObject.createImmutable(2),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 20)))}, "/-",1, 0)),RemoteObject.createImmutable(2)}, "/",0, 0));Debug.locals.put("MaxR", _maxr);Debug.locals.put("MaxR", _maxr);
 BA.debugLineNum = 68;BA.debugLine="Dim r As Float = 10dip + MaxR + MaxR * Sin(Progre";
Debug.JustUpdateDeviceLine();
_r = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 10))),_maxr,_maxr,b4i_main.__c.runMethod(true,"Sin:",(Object)(RemoteObject.solve(new RemoteObject[] {_progress,RemoteObject.createImmutable(2),b4i_main.__c.runMethod(true,"cPI")}, "**",0, 0)))}, "++*",2, 0));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle::::::",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterX"),_r,b4i_main.__c.runMethod(true,"SinD:",(Object)(BA.numberCast(double.class, _alpha)))}, "+*",1, 0))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY"),_r,b4i_main.__c.runMethod(true,"CosD:",(Object)(BA.numberCast(double.class, _alpha)))}, "+*",1, 0))),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 7))))),(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 1))))));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles2 (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,76);
...
Debug.JustUpdateDeviceLine();
_minr = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)));Debug.locals.put("MinR", _minr);Debug.locals.put("MinR", _minr);
 BA.debugLineNum = 78;BA.debugLine="Dim MaxR As Int = cvs.TargetRect.Width / 2 / 3 -";
Debug.JustUpdateDeviceLine();
_maxr = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Width"),RemoteObject.createImmutable(2),RemoteObject.createImmutable(3),_minr,b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2)))}, "//--",2, 0));Debug.locals.put("MaxR", _maxr);Debug.locals.put("MaxR", _maxr);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle::::::",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_maxr,_minr,(RemoteObject.solve(new RemoteObject[] {_minr,_maxr,b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2)))}, "++",2, 1)),RemoteObject.createImmutable(2),RemoteObject.createImmutable(_i)}, "++**",2, 1))),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"CenterY")),(Object)(_r),(Object)(__ref.getField(true,"_clr" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("Hide (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,61);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setVisible:",b4i_main.__c.runMethod(true,"False"));
...
try {
		Debug.PushSubsStack("Initialize (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,20);
...
try {
		Debug.PushSubsStack("MainLoop (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,42);
...
public ResumableSub_MainLoop(b4i_b4xloadingindicator parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
RemoteObject _progress = RemoteObject.createImmutable(0.0f);
...
Debug.JustUpdateDeviceLine();
_progress = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"),_n}, "-",1, 2)),__ref.getField(true,"_duration" /*RemoteObject*/ )}, "/",0, 0));Debug.locals.put("progress", _progress);Debug.locals.put("progress", _progress);
 BA.debugLineNum = 48;BA.debugLine="progress = progress - Floor(progress)";
Debug.JustUpdateDeviceLine();
_progress = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_progress,b4i_main.__c.runMethod(true,"Floor:",(Object)(BA.numberCast(double.class, _progress)))}, "-",1, 0));Debug.locals.put("progress", _progress);
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub2::::",__ref.getField(false, "bi"),(Object)(__ref),(Object)(__ref.getField(true,"_drawingsubname" /*RemoteObject*/ )),(Object)((_progress)));
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xloadingindicator", "mainloop"),BA.numberCast(int.class, 10));
this.state = 5;
return;
case 5:
//C
...
try {
		Debug.PushSubsStack("SetAlpha (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,91);
...
Debug.JustUpdateDeviceLine();
if (true) return RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(false,"Bit").runMethod(true,"And::",(Object)(BA.numberCast(int.class, 0xffffff)),(Object)(_c)),b4i_main.__c.runMethod(false,"Bit").runMethod(true,"ShiftLeft::",(Object)(_alpha),(Object)(BA.numberCast(int.class, 24)))}, "+",1, 1);
...
try {
		Debug.PushSubsStack("Show (b4xloadingindicator) ","b4xloadingindicator",18,__ref.getField(false, "bi"),__ref,56);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setVisible:",b4i_main.__c.runMethod(true,"True"));
