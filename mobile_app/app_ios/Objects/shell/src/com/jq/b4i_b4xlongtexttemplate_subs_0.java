...
public class b4i_b4xlongtexttemplate_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 1;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 2;BA.debugLine="Private xui As XUI";
b4i_b4xlongtexttemplate._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xlongtexttemplate._xui);
 //BA.debugLineNum = 3;BA.debugLine="Public mBase As B4XView";
b4i_b4xlongtexttemplate._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_b4xlongtexttemplate._mbase);
 //BA.debugLineNum = 4;BA.debugLine="Public CustomListView1 As CustomListView";
b4i_b4xlongtexttemplate._customlistview1 = RemoteObject.createNew ("b4i_customlistview");__ref.setField("_customlistview1",b4i_b4xlongtexttemplate._customlistview1);
 //BA.debugLineNum = 5;BA.debugLine="Public Text As Object";
b4i_b4xlongtexttemplate._text = RemoteObject.createNew ("NSObject");__ref.setField("_text",b4i_b4xlongtexttemplate._text);
 //BA.debugLineNum = 6;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _dialogclosed(RemoteObject __ref,RemoteObject _result) throws Exception{
try {
		Debug.PushSubsStack("DialogClosed (b4xlongtexttemplate) ","b4xlongtexttemplate",19,__ref.getField(false, "bi"),__ref,41);
...
try {
		Debug.PushSubsStack("GetPanel (b4xlongtexttemplate) ","b4xlongtexttemplate",19,__ref.getField(false, "bi"),__ref,30);
...
try {
		Debug.PushSubsStack("Initialize (b4xlongtexttemplate) ","b4xlongtexttemplate",19,__ref.getField(false, "bi"),__ref,8);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout::",(Object)(RemoteObject.createImmutable("LongTextTemplate")),__ref.getField(false, "bi"));
...
try {
		Debug.PushSubsStack("Resize (b4xlongtexttemplate) ","b4xlongtexttemplate",19,__ref.getField(false, "bi"),__ref,23);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_asview").runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, _width)),(Object)(BA.numberCast(float.class, _height)));
...
try {
		Debug.PushSubsStack("Show (b4xlongtexttemplate) ","b4xlongtexttemplate",19,__ref.getField(false, "bi"),__ref,34);
