...
public class b4i_b4xsignaturetemplate_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 1;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 2;BA.debugLine="Private xui As XUI";
b4i_b4xsignaturetemplate._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xsignaturetemplate._xui);
 //BA.debugLineNum = 3;BA.debugLine="Public mBase As B4XView";
b4i_b4xsignaturetemplate._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_b4xsignaturetemplate._mbase);
 //BA.debugLineNum = 4;BA.debugLine="Private cvs As B4XCanvas";
b4i_b4xsignaturetemplate._cvs = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvs",b4i_b4xsignaturetemplate._cvs);
 //BA.debugLineNum = 5;BA.debugLine="Private LastX, LastY As Float";
b4i_b4xsignaturetemplate._lastx = RemoteObject.createImmutable(0.0f);__ref.setField("_lastx",b4i_b4xsignaturetemplate._lastx);
b4i_b4xsignaturetemplate._lasty = RemoteObject.createImmutable(0.0f);__ref.setField("_lasty",b4i_b4xsignaturetemplate._lasty);
 //BA.debugLineNum = 6;BA.debugLine="Public StrokeWidth As Float = 2dip";
b4i_b4xsignaturetemplate._strokewidth = BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2))));__ref.setField("_strokewidth",b4i_b4xsignaturetemplate._strokewidth);
 //BA.debugLineNum = 7;BA.debugLine="Public StrokeColor As Int = xui.Color_Black";
b4i_b4xsignaturetemplate._strokecolor = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_Black");__ref.setField("_strokecolor",b4i_b4xsignaturetemplate._strokecolor);
 //BA.debugLineNum = 8;BA.debugLine="Public TextColor As Int = 0xFFFF8800";
b4i_b4xsignaturetemplate._textcolor = BA.numberCast(int.class, 0xffff8800);__ref.setField("_textcolor",b4i_b4xsignaturetemplate._textcolor);
 //BA.debugLineNum = 9;BA.debugLine="Public BackgroundColor As Int = xui.Color_White";
b4i_b4xsignaturetemplate._backgroundcolor = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_White");__ref.setField("_backgroundcolor",b4i_b4xsignaturetemplate._backgroundcolor);
 //BA.debugLineNum = 10;BA.debugLine="Public AddDateAndTime As Boolean = True";
b4i_b4xsignaturetemplate._adddateandtime = b4i_main.__c.runMethod(true,"True");__ref.setField("_adddateandtime",b4i_b4xsignaturetemplate._adddateandtime);
 //BA.debugLineNum = 11;BA.debugLine="Public TextFont As B4XFont";
b4i_b4xsignaturetemplate._textfont = RemoteObject.createNew ("B4XFont");__ref.setField("_textfont",b4i_b4xsignaturetemplate._textfont);
 //BA.debugLineNum = 12;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _dialogclosed(RemoteObject __ref,RemoteObject _result) throws Exception{
try {
		Debug.PushSubsStack("DialogClosed (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,53);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_result,BA.numberCast(double.class, __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"DialogResponse_Positive"))) && RemoteObject.solveBoolean(".",__ref.getField(true,"_adddateandtime" /*RemoteObject*/ ))) { 
...
Debug.JustUpdateDeviceLine();
_baseline = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect").runMethod(true,"Bottom"),_r.runMethod(true,"Height"),_r.runMethod(true,"Top"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2)))}, "---",3, 0));Debug.locals.put("Baseline", _baseline);Debug.locals.put("Baseline", _baseline);
 BA.debugLineNum = 57;BA.debugLine="cvs.DrawText($\"$DateTime{DateTime.Now}\"$, 2dip,";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawText::::::",(Object)((RemoteObject.concat(RemoteObject.createImmutable(""),b4i_main.__c.runMethod(true,"SmartStringFormatter::",(Object)(BA.ObjectToString("datetime")),(Object)((b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now")))),RemoteObject.createImmutable("")))),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 2))))),(Object)(BA.numberCast(float.class, _baseline)),(Object)(__ref.getField(false,"_textfont" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_textcolor" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("LEFT")));
 };
...
try {
		Debug.PushSubsStack("getBitmap (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,49);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,27);
...
try {
		Debug.PushSubsStack("Initialize (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,14);
...
try {
		Debug.PushSubsStack("mBase_Touch (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,36);
...
Debug.JustUpdateDeviceLine();
switch (BA.switchObjectToInt(_action,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_DOWN"),__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"TOUCH_ACTION_MOVE"))) {
case 0: {
...
try {
		Debug.PushSubsStack("Resize (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,21);
...
try {
		Debug.PushSubsStack("Show (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "bi"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawRect::::",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"TargetRect")),(Object)(__ref.getField(true,"_backgroundcolor" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
