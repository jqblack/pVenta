...
public class b4i_b4xswitch_subs_0 {


public static RemoteObject  _base_resize(RemoteObject __ref,RemoteObject _width1,RemoteObject _height1) throws Exception{
try {
		Debug.PushSubsStack("Base_Resize (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,137);
...
b4i_b4xswitch._meventname = RemoteObject.createImmutable("");__ref.setField("_meventname",b4i_b4xswitch._meventname);
 //BA.debugLineNum = 8;BA.debugLine="Private mCallBack As Object 'ignore";
b4i_b4xswitch._mcallback = RemoteObject.createNew ("NSObject");__ref.setField("_mcallback",b4i_b4xswitch._mcallback);
 //BA.debugLineNum = 9;BA.debugLine="Public mBase As B4XView 'ignore";
b4i_b4xswitch._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_b4xswitch._mbase);
 //BA.debugLineNum = 10;BA.debugLine="Private xui As XUI 'ignore";
b4i_b4xswitch._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xswitch._xui);
 //BA.debugLineNum = 11;BA.debugLine="Private OnColor, OffColor As BCBrush";
b4i_b4xswitch._oncolor = RemoteObject.createNew ("_bcbrush");__ref.setField("_oncolor",b4i_b4xswitch._oncolor);
b4i_b4xswitch._offcolor = RemoteObject.createNew ("_bcbrush");__ref.setField("_offcolor",b4i_b4xswitch._offcolor);
 //BA.debugLineNum = 12;BA.debugLine="Private bc As BitmapCreator";
b4i_b4xswitch._bc = RemoteObject.createNew ("b4i_bitmapcreator");__ref.setField("_bc",b4i_b4xswitch._bc);
 //BA.debugLineNum = 13;BA.debugLine="Private Width As Int = 55dip";
b4i_b4xswitch._width = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 55)));__ref.setField("_width",b4i_b4xswitch._width);
 //BA.debugLineNum = 14;BA.debugLine="Private Height As Int = 31dip";
b4i_b4xswitch._height = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 31)));__ref.setField("_height",b4i_b4xswitch._height);
 //BA.debugLineNum = 15;BA.debugLine="Private ThumbColor As BCBrush";
b4i_b4xswitch._thumbcolor = RemoteObject.createNew ("_bcbrush");__ref.setField("_thumbcolor",b4i_b4xswitch._thumbcolor);
 //BA.debugLineNum = 16;BA.debugLine="Private iv As ImageView";
b4i_b4xswitch._iv = RemoteObject.createNew ("B4IImageViewWrapper");__ref.setField("_iv",b4i_b4xswitch._iv);
 //BA.debugLineNum = 17;BA.debugLine="Private mValue As Boolean";
b4i_b4xswitch._mvalue = RemoteObject.createImmutable(false);__ref.setField("_mvalue",b4i_b4xswitch._mvalue);
 //BA.debugLineNum = 18;BA.debugLine="Private transparent As BCBrush";
b4i_b4xswitch._transparent = RemoteObject.createNew ("_bcbrush");__ref.setField("_transparent",b4i_b4xswitch._transparent);
 //BA.debugLineNum = 19;BA.debugLine="Private LoopIndex As Int";
b4i_b4xswitch._loopindex = RemoteObject.createImmutable(0);__ref.setField("_loopindex",b4i_b4xswitch._loopindex);
 //BA.debugLineNum = 20;BA.debugLine="Public Tag As Object";
b4i_b4xswitch._tag = RemoteObject.createNew ("NSObject");__ref.setField("_tag",b4i_b4xswitch._tag);
 //BA.debugLineNum = 21;BA.debugLine="Private Scale As Float";
b4i_b4xswitch._scale = RemoteObject.createImmutable(0.0f);__ref.setField("_scale",b4i_b4xswitch._scale);
 //BA.debugLineNum = 22;BA.debugLine="Private mEnabled As Boolean = True";
b4i_b4xswitch._menabled = b4i_main.__c.runMethod(true,"True");__ref.setField("_menabled",b4i_b4xswitch._menabled);
 //BA.debugLineNum = 23;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _designercreateview(RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) throws Exception{
try {
		Debug.PushSubsStack("DesignerCreateView (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Left")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Top")),(Object)(BA.numberCast(float.class, __ref.getField(true,"_width" /*RemoteObject*/ ))),(Object)(BA.numberCast(float.class, __ref.getField(true,"_height" /*RemoteObject*/ ))));
...
_pnl = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable("pnl")));Debug.locals.put("pnl", _pnl);Debug.locals.put("pnl", _pnl);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_iv" /*RemoteObject*/ ).runVoidMethod ("Initialize::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 39;BA.debugLine="mBase.AddView(iv, 0, 0, Width, Height)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((__ref.getField(false,"_iv" /*RemoteObject*/ )).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, __ref.getField(true,"_width" /*RemoteObject*/ ))),(Object)(BA.numberCast(float.class, __ref.getField(true,"_height" /*RemoteObject*/ ))));
 BA.debugLineNum = 40;BA.debugLine="mBase.AddView(pnl, 0, 0, Width, Height)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((_pnl).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, __ref.getField(true,"_width" /*RemoteObject*/ ))),(Object)(BA.numberCast(float.class, __ref.getField(true,"_height" /*RemoteObject*/ ))));
 BA.debugLineNum = 45;BA.debugLine="Scale = GetDeviceLayoutValues.NonnormalizedScale";
Debug.JustUpdateDeviceLine();
__ref.setField ("_scale" /*RemoteObject*/ ,b4i_main.__c.runMethod(false,"GetDeviceLayoutValues").runMethod(true,"NonnormalizedScale"));
 BA.debugLineNum = 46;BA.debugLine="bc.Initialize(Round(Width * Scale), Round(Height";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bc" /*RemoteObject*/ ).runVoidMethod ("_initialize:::",__ref.getField(false, "bi"),(Object)(BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Round:",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_width" /*RemoteObject*/ ),__ref.getField(true,"_scale" /*RemoteObject*/ )}, "*",0, 0))))),(Object)(BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Round:",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_height" /*RemoteObject*/ ),__ref.getField(true,"_scale" /*RemoteObject*/ )}, "*",0, 0))))));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_transparent" /*RemoteObject*/ ,__ref.getField(false,"_bc" /*RemoteObject*/ ).runMethod(false,"_createbrushfromcolor:",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_Transparent"))));
 BA.debugLineNum = 52;BA.debugLine="mEnabled = mBase.Enabled";
Debug.JustUpdateDeviceLine();
__ref.setField ("_menabled" /*RemoteObject*/ ,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Enabled"));
 BA.debugLineNum = 53;BA.debugLine="mBase.Enabled = True";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setEnabled:",b4i_main.__c.runMethod(true,"True"));
 BA.debugLineNum = 54;BA.debugLine="SetValueImpl(Props.Get(\"Value\"), True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xswitch.class, "_setvalueimpl::" /*void*/ ,(Object)(BA.ObjectToBoolean(_props.runMethod(false,"Get:",(Object)((RemoteObject.createImmutable("Value")))))),(Object)(b4i_main.__c.runMethod(true,"True")));
...
try {
		Debug.PushSubsStack("Draw (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,115);
...
RemoteObject _cx = RemoteObject.createImmutable(0.0f);
RemoteObject _cy = RemoteObject.createImmutable(0);
RemoteObject _smallrect = RemoteObject.declareNull("B4XRect");
RemoteObject _w = RemoteObject.createImmutable(0.0f);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bc" /*RemoteObject*/ ).runVoidMethod ("_drawrect2::::",(Object)(__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(false,"_targetrect")),(Object)(__ref.getField(false,"_transparent" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 117;BA.debugLine="Dim r As Float = Round(bc.mHeight / 2)";
Debug.JustUpdateDeviceLine();
_r = BA.numberCast(float.class, b4i_main.__c.runMethod(true,"Round:",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(true,"_mheight"),RemoteObject.createImmutable(2)}, "/",0, 0))));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
_cx = BA.numberCast(float.class, b4i_main.__c.runMethod(true,"Round:",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(true,"_mwidth"),RemoteObject.createImmutable(1),__ref.getField(true,"_scale" /*RemoteObject*/ ),_r}, "-*-",2, 0))));Debug.locals.put("cx", _cx);
 }}
;
...
Debug.JustUpdateDeviceLine();
_smallrect = RemoteObject.createNew ("B4XRect");Debug.locals.put("smallrect", _smallrect);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",_state,BA.numberCast(double.class, 1))) { 
__ref.getField(false,"_bc" /*RemoteObject*/ ).runVoidMethod ("_drawrectrounded2:::::",(Object)(__ref.getField(false,"_bc" /*RemoteObject*/ ).getField(false,"_targetrect")),(Object)(__ref.getField(false,"_offcolor" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(2),__ref.getField(true,"_scale" /*RemoteObject*/ )}, "*",0, 0))),(Object)(BA.numberCast(int.class, _r)));};
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bc" /*RemoteObject*/ ).runVoidMethod ("_setbitmaptoimageview::",(Object)(__ref.getField(false,"_bc" /*RemoteObject*/ ).runMethod(false,"_getbitmap")),BA.rdebugUtils.runMethod(false, "ConvertToWrapper::", RemoteObject.createNew("B4XViewWrapper"), (__ref.getField(false,"_iv" /*RemoteObject*/ )).getObject()));
...
try {
		Debug.PushSubsStack("getEnabled (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,111);
...
try {
		Debug.PushSubsStack("getValue (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,102);
...
try {
		Debug.PushSubsStack("Initialize (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,25);
...
try {
		Debug.PushSubsStack("pnl_Click (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,67);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xswitch.class, "_setvalueimpl::" /*void*/ ,(Object)(b4i_main.__c.runMethod(true,"Not:",(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )))),(Object)(b4i_main.__c.runMethod(true,"False")));
 BA.debugLineNum = 71;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_ValueC";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("CallSubDelayed2::::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_ValueChanged"))),(Object)((__ref.getField(true,"_mvalue" /*RemoteObject*/ ))));
 };
...
try {
		Debug.PushSubsStack("setEnabled (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,106);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xswitch.class, "_setvalueimpl::" /*void*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")));
...
try {
		Debug.PushSubsStack("setValue (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,97);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xswitch.class, "_setvalueimpl::" /*void*/ ,(Object)(_b),(Object)(b4i_main.__c.runMethod(true,"False")));
...
try {
		Debug.PushSubsStack("SetValueImpl (b4xswitch) ","b4xswitch",23,__ref.getField(false, "bi"),__ref,75);
...
public ResumableSub_SetValueImpl(b4i_b4xswitch parent,RemoteObject __ref,RemoteObject _b,RemoteObject _immediate) {
this.parent = parent;
this.__ref = __ref;
this._b = _b;
...
RemoteObject _state1 = RemoteObject.createImmutable(0.0f);
...
//if
this.state = 11;
if (__ref.getField(true,"_mvalue" /*RemoteObject*/ ).getBoolean()) { 
this.state = 6;
;}
else {
this.state = 8;
...
//C
this.state = 11;
__ref.runClassMethod (b4i_b4xswitch.class, "_draw:" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 1)));
if (true) break;

case 8:
//C
this.state = 11;
__ref.runClassMethod (b4i_b4xswitch.class, "_draw:" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 0)));
if (true) break;
...
Debug.JustUpdateDeviceLine();
_start = b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now");Debug.locals.put("start", _start);Debug.locals.put("start", _start);
...
//do while
this.state = 29;
while (RemoteObject.solveBoolean("<",b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_start,_duration}, "+",1, 2)))) {
this.state = 16;
if (true) break;
}
if (true) break;
...
Debug.JustUpdateDeviceLine();
_state1 = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {b4i_main.__c.runMethod(false,"DateTime").runMethod(true,"Now"),_start}, "-",1, 2)),_duration}, "/",0, 0));Debug.locals.put("state1", _state1);Debug.locals.put("state1", _state1);
...
//if
this.state = 22;
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_mvalue" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False"))) { 
this.state = 19;
;}if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xswitch.class, "_draw:" /*RemoteObject*/ ,(Object)(_state1));
 BA.debugLineNum = 88;BA.debugLine="Sleep(16)";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xswitch", "setvalueimpl"),BA.numberCast(int.class, 16));
this.state = 42;
return;
case 42:
//C
