...
public class b4i_b4xtimedtemplate_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 1;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 2;BA.debugLine="Private xui As XUI";
b4i_b4xtimedtemplate._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_b4xtimedtemplate._xui);
 //BA.debugLineNum = 3;BA.debugLine="Public mBase As B4XView";
b4i_b4xtimedtemplate._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_b4xtimedtemplate._mbase);
 //BA.debugLineNum = 4;BA.debugLine="Private AnotherProgressBar1 As AnotherProgressBar";
b4i_b4xtimedtemplate._anotherprogressbar1 = RemoteObject.createNew ("b4i_anotherprogressbar");__ref.setField("_anotherprogressbar1",b4i_b4xtimedtemplate._anotherprogressbar1);
 //BA.debugLineNum = 5;BA.debugLine="Private mTemplate As Object";
b4i_b4xtimedtemplate._mtemplate = RemoteObject.createNew ("NSObject");__ref.setField("_mtemplate",b4i_b4xtimedtemplate._mtemplate);
 //BA.debugLineNum = 6;BA.debugLine="Public TimeoutMilliseconds As Int = 10000";
b4i_b4xtimedtemplate._timeoutmilliseconds = BA.numberCast(int.class, 10000);__ref.setField("_timeoutmilliseconds",b4i_b4xtimedtemplate._timeoutmilliseconds);
 //BA.debugLineNum = 7;BA.debugLine="Private Index As Int";
b4i_b4xtimedtemplate._index = RemoteObject.createImmutable(0);__ref.setField("_index",b4i_b4xtimedtemplate._index);
 //BA.debugLineNum = 8;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _dialogclosed(RemoteObject __ref,RemoteObject _result) throws Exception{
try {
		Debug.PushSubsStack("DialogClosed (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "bi"),__ref,41);
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub2::::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mtemplate" /*RemoteObject*/ )),(Object)(BA.ObjectToString("DialogClosed")),(Object)((_result)));
...
try {
		Debug.PushSubsStack("GetPanel (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "bi"),__ref,16);
if (RapidSub.canDelegate("getpanel")) { return __ref.runUserSub(false, "b4xtimedtemplate","getpanel", __ref, _dialog);}
RemoteObject _innerpanel = RemoteObject.declareNull("B4XViewWrapper");
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"NumberOfViews"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 18;BA.debugLine="Dim InnerPanel As B4XView = CallSub2(mTemplate,";
Debug.JustUpdateDeviceLine();
_innerpanel = RemoteObject.createNew ("B4XViewWrapper");
_innerpanel.setObject(b4i_main.__c.runMethodAndSync(false,"CallSub2::::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mtemplate" /*RemoteObject*/ )),(Object)(BA.ObjectToString("GetPanel")),(Object)((_dialog))));Debug.locals.put("InnerPanel", _innerpanel);
 BA.debugLineNum = 19;BA.debugLine="If InnerPanel.Parent.IsInitialized Then InnerPan";
Debug.JustUpdateDeviceLine();
if (_innerpanel.runMethod(false,"Parent").runMethod(true,"IsInitialized").getBoolean()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(_innerpanel.runMethod(true,"Width")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_innerpanel.runMethod(true,"Height"),b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 19)))}, "+",1, 0))));
 BA.debugLineNum = 21;BA.debugLine="mBase.LoadLayout(\"TimedDialogTemplate\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout::",(Object)(RemoteObject.createImmutable("TimedDialogTemplate")),__ref.getField(false, "bi"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((_innerpanel).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 19))))),(Object)(_innerpanel.runMethod(true,"Width")),(Object)(_innerpanel.runMethod(true,"Height")));
 };
...
try {
		Debug.PushSubsStack("Initialize (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "bi"),__ref,10);
...
try {
		Debug.PushSubsStack("Show (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "bi"),__ref,28);
...
public ResumableSub_Show(b4i_b4xtimedtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethodAndSync(false,"CallSub2::::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mtemplate" /*RemoteObject*/ )),(Object)(BA.ObjectToString("Show")),(Object)((_dialog)));
 BA.debugLineNum = 30;BA.debugLine="AnotherProgressBar1.SetValueNoAnimation(0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_anotherprogressbar1" /*RemoteObject*/ ).runClassMethod (b4i_anotherprogressbar.class, "_setvaluenoanimation:" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_anotherprogressbar1" /*RemoteObject*/ ).runClassMethod (b4i_anotherprogressbar.class, "_setvalue:" /*RemoteObject*/ ,BA.numberCast(int.class, 100));
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xtimedtemplate", "show"),__ref.getField(true,"_timeoutmilliseconds" /*RemoteObject*/ ));
this.state = 5;
return;
case 5:
//C
...
Debug.JustUpdateDeviceLine();
_dialog.runClassMethod (b4i_b4xdialog.class, "_close:" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"DialogResponse_Cancel")));
 if (true) break;
