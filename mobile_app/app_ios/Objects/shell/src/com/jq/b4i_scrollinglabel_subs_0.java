...
public class b4i_scrollinglabel_subs_0 {


public static RemoteObject  _base_resize(RemoteObject __ref,RemoteObject _width,RemoteObject _height) throws Exception{
try {
		Debug.PushSubsStack("Base_Resize (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,38);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_scrollinglabel.class, "_settext:" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
...
b4i_scrollinglabel._meventname = RemoteObject.createImmutable("");__ref.setField("_meventname",b4i_scrollinglabel._meventname);
 //BA.debugLineNum = 4;BA.debugLine="Private mCallBack As Object 'ignore";
b4i_scrollinglabel._mcallback = RemoteObject.createNew ("NSObject");__ref.setField("_mcallback",b4i_scrollinglabel._mcallback);
 //BA.debugLineNum = 5;BA.debugLine="Public mBase As B4XView";
b4i_scrollinglabel._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_scrollinglabel._mbase);
 //BA.debugLineNum = 6;BA.debugLine="Private xui As XUI 'ignore";
b4i_scrollinglabel._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_scrollinglabel._xui);
 //BA.debugLineNum = 7;BA.debugLine="Private mText As String";
b4i_scrollinglabel._mtext = RemoteObject.createImmutable("");__ref.setField("_mtext",b4i_scrollinglabel._mtext);
 //BA.debugLineNum = 8;BA.debugLine="Private taskIndex As Int";
b4i_scrollinglabel._taskindex = RemoteObject.createImmutable(0);__ref.setField("_taskindex",b4i_scrollinglabel._taskindex);
 //BA.debugLineNum = 9;BA.debugLine="Private WidthPerSecond As Int = 100dip";
b4i_scrollinglabel._widthpersecond = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 100)));__ref.setField("_widthpersecond",b4i_scrollinglabel._widthpersecond);
 //BA.debugLineNum = 10;BA.debugLine="Private fnt As B4XFont";
b4i_scrollinglabel._fnt = RemoteObject.createNew ("B4XFont");__ref.setField("_fnt",b4i_scrollinglabel._fnt);
 //BA.debugLineNum = 11;BA.debugLine="Private cvs As B4XCanvas";
b4i_scrollinglabel._cvs = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvs",b4i_scrollinglabel._cvs);
 //BA.debugLineNum = 12;BA.debugLine="Public Tag As Object";
b4i_scrollinglabel._tag = RemoteObject.createNew ("NSObject");__ref.setField("_tag",b4i_scrollinglabel._tag);
 //BA.debugLineNum = 13;BA.debugLine="Public StartPositionDelay As Int = 1000";
b4i_scrollinglabel._startpositiondelay = BA.numberCast(int.class, 1000);__ref.setField("_startpositiondelay",b4i_scrollinglabel._startpositiondelay);
 //BA.debugLineNum = 14;BA.debugLine="Private mTextColor As Int = xui.Color_Black";
b4i_scrollinglabel._mtextcolor = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_Black");__ref.setField("_mtextcolor",b4i_scrollinglabel._mtextcolor);
 //BA.debugLineNum = 15;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _designercreateview(RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) throws Exception{
try {
		Debug.PushSubsStack("DesignerCreateView (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,23);
...
RemoteObject _l = RemoteObject.declareNull("B4XViewWrapper");
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((_p).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height")));
 BA.debugLineNum = 29;BA.debugLine="mText = Lbl.Text";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mtext" /*RemoteObject*/ ,_lbl.runMethod(true,"Text"));
 BA.debugLineNum = 30;BA.debugLine="Dim l As B4XView = Lbl";
Debug.JustUpdateDeviceLine();
_l = RemoteObject.createNew ("B4XViewWrapper");
_l.setObject((_lbl).getObject());Debug.locals.put("l", _l);
 BA.debugLineNum = 31;BA.debugLine="fnt = l.Font";
Debug.JustUpdateDeviceLine();
__ref.setField ("_fnt" /*RemoteObject*/ ,_l.runMethod(false,"Font"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("Initialize:",(Object)(((_p).getObject())));
...
try {
		Debug.PushSubsStack("getText (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,91);
...
try {
		Debug.PushSubsStack("getTextColor (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,124);
...
try {
		Debug.PushSubsStack("Initialize (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,18);
...
try {
		Debug.PushSubsStack("MeasureTextWidth (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,115);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"MeasureText::",(Object)(_s),(Object)(_font1)).runMethod(true,"Width");
...
try {
		Debug.PushSubsStack("setText (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,43);
...
RemoteObject _originaltextwidth = RemoteObject.createImmutable(0.0f);
...
Debug.JustUpdateDeviceLine();
_needtocreatenewlabel = b4i_main.__c.runMethod(true,"True");Debug.locals.put("NeedToCreateNewLabel", _needtocreatenewlabel);Debug.locals.put("NeedToCreateNewLabel", _needtocreatenewlabel);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_parent.runMethod(true,"NumberOfViews"),BA.numberCast(double.class, 0))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_p.runMethod(false,"Tag"),RemoteObject.createImmutable(("static")))) { 
 BA.debugLineNum = 50;BA.debugLine="NeedToCreateNewLabel = False";
Debug.JustUpdateDeviceLine();
_needtocreatenewlabel = b4i_main.__c.runMethod(true,"False");Debug.locals.put("NeedToCreateNewLabel", _needtocreatenewlabel);
 BA.debugLineNum = 51;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, parent.Width, pare";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(_parent.runMethod(true,"Width")),(Object)(_parent.runMethod(true,"Height")));
...
Debug.JustUpdateDeviceLine();
_xlbl.runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(_parent.runMethod(true,"Width")),(Object)(_parent.runMethod(true,"Height")));
 };
 };
 BA.debugLineNum = 57;BA.debugLine="Dim originalTextWidth As Float = MeasureTextWidth";
Debug.JustUpdateDeviceLine();
_originaltextwidth = __ref.runClassMethod (b4i_scrollinglabel.class, "_measuretextwidth::" /*RemoteObject*/ ,(Object)(_t),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("originalTextWidth", _originaltextwidth);Debug.locals.put("originalTextWidth", _originaltextwidth);
...
Debug.JustUpdateDeviceLine();
if (_needtocreatenewlabel.getBoolean()) { 
...
Debug.JustUpdateDeviceLine();
_parent.runVoidMethod ("AddView:::::",(Object)(((_p).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(_parent.runMethod(true,"Width")),(Object)(_parent.runMethod(true,"Height")));
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("AddView:::::",(Object)(((_xlbl).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height")));
 };
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("k",_originaltextwidth,BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width")))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_scrollinglabel.class, "_stopscrolling" /*RemoteObject*/ );
 }else {
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (b4i_scrollinglabel.class, "_measuretextwidth::" /*RemoteObject*/ ,(Object)(_duplicatetext),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("Width", _width);Debug.locals.put("Width", _width);
...
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setWidth:",_width);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_scrollinglabel.class, "_startscrolling::" /*void*/ ,(Object)(_p),(Object)(_originaltextwidth));
 };
...
try {
		Debug.PushSubsStack("setTextColor (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,119);
...
try {
		Debug.PushSubsStack("StartScrolling (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,99);
...
public ResumableSub_StartScrolling(b4i_scrollinglabel parent,RemoteObject __ref,RemoteObject _p,RemoteObject _originalwidth) {
this.parent = parent;
this.__ref = __ref;
this._p = _p;
...
Debug.JustUpdateDeviceLine();
_duration = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"Width"),__ref.getField(true,"_widthpersecond" /*RemoteObject*/ ),RemoteObject.createImmutable(1000)}, "/*",0, 0));Debug.locals.put("duration", _duration);Debug.locals.put("duration", _duration);
 BA.debugLineNum = 103;BA.debugLine="Sleep(StartPositionDelay)";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "scrollinglabel", "startscrolling"),__ref.getField(true,"_startpositiondelay" /*RemoteObject*/ ));
this.state = 23;
return;
case 23:
//C
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated:::::",(Object)(_duration),(Object)(BA.numberCast(float.class, -(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"Width"),_originalwidth}, "-",1, 0)).<Number>get().doubleValue())),(Object)(_p.runMethod(true,"Top")),(Object)(_p.runMethod(true,"Width")),(Object)(_p.runMethod(true,"Height")));
 BA.debugLineNum = 107;BA.debugLine="Sleep(duration)";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("Sleep:::",__ref.getField(false, "bi"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "scrollinglabel", "startscrolling"),_duration);
this.state = 24;
return;
case 24:
//C
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated:::::",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(_p.runMethod(true,"Top")),(Object)(_p.runMethod(true,"Width")),(Object)(_p.runMethod(true,"Height")));
 if (true) break;
...
try {
		Debug.PushSubsStack("StopScrolling (scrollinglabel) ","scrollinglabel",27,__ref.getField(false, "bi"),__ref,95);
