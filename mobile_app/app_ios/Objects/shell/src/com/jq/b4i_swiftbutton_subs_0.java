...
public class b4i_swiftbutton_subs_0 {


public static RemoteObject  _base_resize(RemoteObject __ref,RemoteObject _width,RemoteObject _height) throws Exception{
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,39);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_swiftbutton.class, "_draw" /*RemoteObject*/ );
...
b4i_swiftbutton._meventname = RemoteObject.createImmutable("");__ref.setField("_meventname",b4i_swiftbutton._meventname);
 //BA.debugLineNum = 7;BA.debugLine="Private mCallBack As Object 'ignore";
b4i_swiftbutton._mcallback = RemoteObject.createNew ("NSObject");__ref.setField("_mcallback",b4i_swiftbutton._mcallback);
 //BA.debugLineNum = 8;BA.debugLine="Public mBase As B4XView 'ignore";
b4i_swiftbutton._mbase = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_mbase",b4i_swiftbutton._mbase);
 //BA.debugLineNum = 9;BA.debugLine="Private xui As XUI 'ignore";
b4i_swiftbutton._xui = RemoteObject.createNew ("B4IXUI");__ref.setField("_xui",b4i_swiftbutton._xui);
 //BA.debugLineNum = 10;BA.debugLine="Private cvs As B4XCanvas";
b4i_swiftbutton._cvs = RemoteObject.createNew ("B4XCanvas");__ref.setField("_cvs",b4i_swiftbutton._cvs);
 //BA.debugLineNum = 11;BA.debugLine="Public xLBL As B4XView";
b4i_swiftbutton._xlbl = RemoteObject.createNew ("B4XViewWrapper");__ref.setField("_xlbl",b4i_swiftbutton._xlbl);
 //BA.debugLineNum = 12;BA.debugLine="Private clr1, clr2, disabledColor As Int";
b4i_swiftbutton._clr1 = RemoteObject.createImmutable(0);__ref.setField("_clr1",b4i_swiftbutton._clr1);
b4i_swiftbutton._clr2 = RemoteObject.createImmutable(0);__ref.setField("_clr2",b4i_swiftbutton._clr2);
b4i_swiftbutton._disabledcolor = RemoteObject.createImmutable(0);__ref.setField("_disabledcolor",b4i_swiftbutton._disabledcolor);
 //BA.debugLineNum = 13;BA.debugLine="Private pressed As Boolean";
b4i_swiftbutton._pressed = RemoteObject.createImmutable(false);__ref.setField("_pressed",b4i_swiftbutton._pressed);
 //BA.debugLineNum = 14;BA.debugLine="Public Tag As Object";
b4i_swiftbutton._tag = RemoteObject.createNew ("NSObject");__ref.setField("_tag",b4i_swiftbutton._tag);
 //BA.debugLineNum = 15;BA.debugLine="Private mDisabled As Boolean";
b4i_swiftbutton._mdisabled = RemoteObject.createImmutable(false);__ref.setField("_mdisabled",b4i_swiftbutton._mdisabled);
 //BA.debugLineNum = 16;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _designercreateview(RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) throws Exception{
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,23);
...
_p = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel::",__ref.getField(false, "bi"),(Object)(RemoteObject.createImmutable("p")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 27;BA.debugLine="p.Color = xui.Color_Transparent";
Debug.JustUpdateDeviceLine();
_p.runMethod(true,"setColor:",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"Color_Transparent"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView:::::",(Object)(((_p).getObject())),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_swiftbutton.class, "_base_resize::" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"))));
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,90);
...
Debug.JustUpdateDeviceLine();
_gap = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 5)));Debug.locals.put("gap", _gap);Debug.locals.put("gap", _gap);
 BA.debugLineNum = 93;BA.debugLine="Dim corners As Int = 15dip";
Debug.JustUpdateDeviceLine();
_corners = b4i_main.__c.runMethod(true,"DipToCurrent:",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("corners", _corners);Debug.locals.put("corners", _corners);
...
Debug.JustUpdateDeviceLine();
_r.runVoidMethod ("Initialize::::",(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, _gap)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height")));
 BA.debugLineNum = 97;BA.debugLine="If pressed = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_pressed" /*RemoteObject*/ ),b4i_main.__c.runMethod(true,"False"))) { 
 BA.debugLineNum = 98;BA.debugLine="xLBL.Top = 0";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setTop:",BA.numberCast(float.class, 0));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawPath::::",(Object)(_p),(Object)(__ref.getField(true,"_clr2" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 101;BA.debugLine="r.Initialize(0, 0, mBase.Width, mBase.Height - g";
Debug.JustUpdateDeviceLine();
_r.runVoidMethod ("Initialize::::",(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Width")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"Height"),_gap}, "-",1, 0))));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawPath::::",(Object)(_p),(Object)(__ref.getField(true,"_clr1" /*RemoteObject*/ )),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 }else {
 BA.debugLineNum = 105;BA.debugLine="xLBL.Top = gap";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setTop:",BA.numberCast(float.class, _gap));
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_mdisabled" /*RemoteObject*/ ).getBoolean()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawPath::::",(Object)(_p),(Object)(_c),(Object)(b4i_main.__c.runMethod(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 };
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,47);
...
Debug.JustUpdateDeviceLine();
if (true) return b4i_main.__c.runMethod(true,"Not:",(Object)(__ref.getField(true,"_mdisabled" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,18);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,57);
...
Debug.JustUpdateDeviceLine();
if (_inside.getBoolean()) { 
 BA.debugLineNum = 73;BA.debugLine="CallSubDelayed(mCallBack, mEventName & \"_Click";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("CallSubDelayed:::",__ref.getField(false, "bi"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Click"))));
 };
 break; }
}
;
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,84);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",28,__ref.getField(false, "bi"),__ref,51);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_mdisabled" /*RemoteObject*/ ,b4i_main.__c.runMethod(true,"Not:",(Object)(_b)));
