...
@interface b4i_b4xtimedtemplate : B4IClass
{
@public B4IXUI* __xui;
@public B4XViewWrapper* __mbase;
@public b4i_anotherprogressbar* __anotherprogressbar1;
@public NSObject* __mtemplate;
@public int __timeoutmilliseconds;
@public int __index;
...
@property (nonatomic)b4i_anotherprogressbar* _anotherprogressbar1;
@property (nonatomic)NSObject* _mtemplate;
@property (nonatomic)int _timeoutmilliseconds;
