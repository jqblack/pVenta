...
@interface b4i_scrollinglabel : B4IClass
{
...
@public int __taskindex;
@public int __widthpersecond;
@public B4XFont* __fnt;
@public B4XCanvas* __cvs;
@public NSObject* __tag;
@public int __startpositiondelay;
@public int __mtextcolor;
...
@property (nonatomic)int _taskindex;
@property (nonatomic)int _widthpersecond;
@property (nonatomic)B4XFont* _fnt;
@property (nonatomic)B4XCanvas* _cvs;
@property (nonatomic)NSObject* _tag;
@property (nonatomic)int _startpositiondelay;
@property (nonatomic)int _mtextcolor;
