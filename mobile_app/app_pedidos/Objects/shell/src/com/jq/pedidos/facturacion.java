...
public class facturacion implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("facturacion"), "com.jq.pedidos.facturacion");
	}
