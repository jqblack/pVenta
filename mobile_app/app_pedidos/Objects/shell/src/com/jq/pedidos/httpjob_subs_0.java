...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,239);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,197);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,202);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,167);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,177);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,254);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,265);
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,261);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,271);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,234);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,215);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (com.jq.pedidos.httpjob.class, "_getstring2" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("UTF8")));
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,74);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,128);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,53);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_patchbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,139);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","916777223",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_out.runMethod(false,"ToBytesArray")));
 }else {
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,82);
...
RemoteObject _fd = RemoteObject.declareNull("com.jq.pedidos.httpjob._multipartfiledata");
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
_empty = __ref.runClassMethod (com.jq.pedidos.httpjob.class, "_multipartstartsection" /*RemoteObject*/ ,(Object)(_stream),(Object)(_empty));Debug.locals.put("empty", _empty);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_stream.runMethod(false,"ToBytesArray")));
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,42);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.jq.pedidos.httpjob.class, "_putbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,208);
