...
views.get("panelslide").vw.setHeight((int)((56d / 100 * height)));
...
views.get("panelslide").vw.setTop((int)((20d / 100 * height)));
...
views.get("panelcategoria").vw.setLeft((int)((views.get("panel3").vw.getLeft())));
views.get("panelcategoria").vw.setWidth((int)((views.get("panel3").vw.getWidth())));
views.get("panelcategoria").vw.setHeight((int)((views.get("panel3").vw.getHeight())));
views.get("panelcategoria").vw.setTop((int)((views.get("panel4").vw.getTop() + views.get("panel4").vw.getHeight())+(2d / 100 * height)));
views.get("label8").vw.setLeft((int)((views.get("label3").vw.getLeft())));
views.get("label8").vw.setTop((int)((views.get("label3").vw.getTop())));
...
views.get("label9").vw.setLeft((int)((views.get("label2").vw.getLeft())));
views.get("label9").vw.setTop((int)((views.get("label2").vw.getTop())));
views.get("label9").vw.setWidth((int)((views.get("label2").vw.getWidth())));
views.get("label9").vw.setHeight((int)((views.get("label2").vw.getHeight())));
...
views.get("panel5").vw.setTop((int)((views.get("panelcategoria").vw.getTop() + views.get("panelcategoria").vw.getHeight())+(2d / 100 * height)));
