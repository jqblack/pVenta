...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",12,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,95);
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",12,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,82);
...
Debug.JustUpdateDeviceLine();
b4i_main.__c.runVoidMethod ("LogImpl:::","93604481",RemoteObject.concat(RemoteObject.createImmutable("ResponseError: "),_reason,RemoteObject.createImmutable(", status code: "),_statuscode),0);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",12,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,87);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",12,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,13);
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",12,b4i_httputils2service.ba,b4i_httputils2service.mostCurrent,42);
