...
println("Entro");
        ...
        println(map.get("f_key").toString())
        println(funciones.encodeAsMD5("jQmS#2013@2019#@"))
...
//
//    @RequestMapping(value = "/get_productos_main_page2", method = RequestMethod.POST)
//    def get_productos_main_page2(@RequestParam(name = "json") String dato) {
//        String dato1 = new String(dato.decodeBase64());
//        println("Entro");
//        Map map = JSON.parse(dato1);
//        Map tupla = JSON.parse(map.get("f_data").toString());
//
//            return funciones.convertir('1', "HOLA").replace("'", '"').replace('"[', '[').replace(']"', ']');
//
//
//    }
