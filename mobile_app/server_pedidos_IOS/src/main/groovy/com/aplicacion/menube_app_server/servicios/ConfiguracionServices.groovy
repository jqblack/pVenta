...
class ConfiguracionServices {
    ...
    @Transactional
    def InsertarDetalleTemporal2(Long idproducto, String referencia, BigDecimal cantidad,
                                 BigDecimal precio, BigDecimal tax, String token, BigDecimal importe, Long idempresa,
                                 Boolean regresa_inventario, BigDecimal descuento, String idusuario,
                                 BigDecimal porciento_descuento, BigDecimal porciento_tax,String f_comentario) {
        String sql = "INSERT INTO \n" +
